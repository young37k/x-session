...
function rankingGroupMatchesFilter(selectedGroup, actualGroup) {
  ...
  if (selectedGroup === "초등부(통합)") {
    return actualGroup === "초등부(통합)" || actualGroup === "초등부(저학년)" || actualGroup === "초등부(고학년)" || actualGroup === "초등부(고학년)";
  }
...
const SAMPLE_SHEETS = [{
    ...
    rows: [
      { name: "황리우", school: "천현초", rounds: [302, 315, 332, 333], total: 1282 },
      { name: "김설", school: "서초", rounds: [277, 312, 314, 332], total: 1235 },
      { name: "김태리", school: "하성초", rounds: [271, 302, 320, 334], total: 1227 },
      { name: "조유나", school: "수진초", rounds: [271, 302, 311, 326], total: 1210 },
      { name: "장윤혜", school: "송정초", rounds: [282, 288, 293, 336], total: 1199 },
      { name: "원율", school: "여흥초", rounds: [264, 291, 319, 310], total: 1184 },
      { name: "김서우", school: "수진초", rounds: [279, 276, 302, 291], total: 1148 },
      { name: "홍지수", school: "송정초", rounds: [248, 264, 294, 318], total: 1124 },
      { name: "김소율", school: "타겟28양궁클럽", rounds: [278, 232, 272, 326], total: 1108 },
      { name: "강민서", school: "여흥초", rounds: [253, 263, 270, 303], total: 1089 },
      { name: "조윤서", school: "서초", rounds: [253, 242, 277, 300], total: 1072 },
      { name: "송의나", school: "수진초", rounds: [227, 270, 269, 304], total: 1070 },
      { name: "백수연", school: "여흥초", rounds: [202, 270, 275, 320], total: 1067 },
      { name: "김윤서", school: "원미초", rounds: [195, 255, 290, 301], total: 1041 },
      { name: "백가은", school: "서초", rounds: [165, 216, 273, 288], total: 942 },
      { name: "김민채", school: "천현초", rounds: [225, 213, 250, 243], total: 931 },
      { name: "조예늘", school: "하성초", rounds: [189, 203, 250, 278], total: 920 },
      { name: "윤이진", school: "여흥초", rounds: [145, 194, 231, 307], total: 877 },
      { name: "고은", school: "서초", rounds: [177, 212, 229, 255], total: 873 },
      { name: "황리안", school: "천현초", rounds: [159, 152, 209, 245], total: 765 },
      { name: "이주아", school: "서초", rounds: [65, 138, 117, 184], total: 504 },
    ],
  },
  {
    id: "sheet_2026_04_12",
    ...
    distances: [35, 30, 25, 20],
    rows: [
      { name: "황리우", school: "천현초", rounds: [305, 325, 339, 343], total: 1312 },
      { name: "김태리", school: "하성초", rounds: [298, 311, 322, 345], total: 1276 },
      { name: "조유나", school: "수진초", rounds: [292, 301, 319, 339], total: 1251 },
      { name: "장윤혜", school: "송정초", rounds: [294, 286, 320, 330], total: 1230 },
      { name: "김서우", school: "수진초", rounds: [262, 304, 323, 338], total: 1227 },
      { name: "김설", school: "서초", rounds: [270, 301, 315, 327], total: 1213 },
      { name: "강민서", school: "여흥초", rounds: [272, 288, 317, 325], total: 1202 },
      { name: "김소율", school: "타겟28양궁클럽", rounds: [244, 275, 307, 332], total: 1158 },
      { name: "홍지수", school: "송정초", rounds: [257, 288, 294, 314], total: 1153 },
      { name: "원율", school: "여흥초", rounds: [242, 261, 308, 327], total: 1138 },
      { name: "송의나", school: "수진초", rounds: [246, 257, 307, 325], total: 1135 },
      { name: "김민채", school: "천현초", rounds: [222, 236, 288, 307], total: 1053 },
      { name: "백가은", school: "서초", rounds: [238, 230, 272, 302], total: 1042 },
      { name: "조예늘", school: "하성초", rounds: [166, 242, 292, 304], total: 1004 },
      { name: "백수연", school: "여흥초", rounds: [179, 245, 252, 292], total: 968 },
      { name: "김윤서", school: "원미초", rounds: [165, 198, 258, 249], total: 870 },
      { name: "조윤서", school: "서초", rounds: [190, 230, 218, 223], total: 861 },
      { name: "윤이진", school: "여흥초", rounds: [139, 185, 252, 267], total: 843 },
      { name: "고은", school: "서초", rounds: [139, 185, 207, 260], total: 829 },
      { name: "황리안", school: "천현초", rounds: [157, 205, 211, 281], total: 755 },
      { name: "김바다", school: "당정초", rounds: [112, 151, 263, 312], total: 575 },
      { name: "이주아", school: "서초", rounds: [55, 116, 79, 106], total: 356 },
    ],
  },
  {
    ...
    distances: [35, 30, 25, 20],
    rows: [
      { name: "김영재", school: "연무초", rounds: [337, 342, 342, 351], total: 1372 },
      { name: "유선유", school: "연무초", rounds: [313, 324, 337, 345], total: 1319 },
      { name: "박찬영", school: "원미초", rounds: [276, 310, 291, 302], total: 1179 },
      { name: "박도현", school: "성포초", rounds: [269, 291, 284, 329], total: 1173 },
      { name: "장다준", school: "하성초", rounds: [261, 231, 288, 314], total: 1094 },
      { name: "최우빈", school: "천현초", rounds: [239, 253, 294, 300], total: 1086 },
      { name: "구교준", school: "천현초", rounds: [179, 222, 266, 314], total: 981 },
      { name: "오태준", school: "성포초", rounds: [56, 0, 196, 282], total: 534 },
    ],
  },
  {
    ...
    distances: [35, 30, 25, 20],
    rows: [
      { name: "장은혁", school: "연무초", rounds: [333, 349, 344, 357], total: 1383 },
      { name: "김영재", school: "연무초", rounds: [337, 342, 342, 351], total: 1372 },
      { name: "최광빈", school: "천현초", rounds: [339, 331, 345, 354], total: 1369 },
      { name: "백종준", school: "천현초", rounds: [328, 329, 343, 353], total: 1353 },
      { name: "최수혁", school: "성포초", rounds: [326, 342, 337, 347], total: 1352 },
      { name: "이우현", school: "하성초", rounds: [320, 338, 341, 343], total: 1342 },
      { name: "정선우", school: "연무초", rounds: [322, 330, 344, 345], total: 1341 },
      { name: "김준서", school: "성포초", rounds: [335, 318, 336, 340], total: 1329 },
      { name: "임태서", school: "연무초", rounds: [307, 315, 347, 353], total: 1322 },
      { name: "유선유", school: "연무초", rounds: [313, 324, 337, 345], total: 1319 },
      { name: "배재윤", school: "성포초", rounds: [316, 322, 334, 345], total: 1317 },
      { name: "김영민", school: "연무초", rounds: [305, 319, 334, 339], total: 1297 },
      { name: "김태원", school: "수진초", rounds: [286, 312, 323, 322], total: 1243 },
      { name: "진준호", school: "천현초", rounds: [279, 310, 305, 319], total: 1213 },
      { name: "방도율", school: "당정초", rounds: [286, 282, 312, 314], total: 1194 },
      { name: "김민준", school: "원미초", rounds: [291, 264, 310, 326], total: 1191 },
      { name: "박찬영", school: "원미초", rounds: [276, 310, 291, 302], total: 1179 },
      { name: "박도현", school: "성포초", rounds: [269, 291, 284, 329], total: 1173 },
      { name: "김선율", school: "당정초", rounds: [240, 268, 299, 307], total: 1114 },
      { name: "권순용", school: "연무초", rounds: [254, 271, 281, 304], total: 1110 },
      { name: "장다준", school: "하성초", rounds: [261, 231, 288, 314], total: 1094 },
      { name: "최우빈", school: "천현초", rounds: [239, 253, 294, 300], total: 1086 },
      { name: "구교준", school: "천현초", rounds: [179, 222, 266, 314], total: 981 },
      { name: "오태준", school: "성포초", rounds: [56, 0, 196, 282], total: 534 },
      { name: "윤주안", school: "성포초", rounds: [0, 0, 207, 277], total: 484 },
    ],
  },
  {
    ...
    rows: [
      ...
      { name: "조윤서", school: "서초", rounds: [190, 230, 218, 223], total: 861 },
      { name: "윤이진", school: "여흥초", rounds: [139, 185, 252, 267], total: 843 },
      { name: "고은", school: "서초", rounds: [157, 205, 207, 260], total: 829 },
      { name: "황리안", school: "천현초", rounds: [112, 151, 211, 281], total: 755 },
      { name: "김바다", school: "당정초", rounds: [0, 0, 263, 312], total: 575 },
      { name: "이주아", school: "서초", rounds: [55, 116, 79, 106], total: 356 },
    ],
  },
  {
    ...
    distances: [35, 30, 25, 20],
    rows: [
      { name: "원서아", school: "하성초", division: "초등5", rounds: [343, 352, 346, 352], total: 1393 },
      { name: "조유나", school: "하성초", rounds: [325, 343, 339, 354], total: 1361 },
      { name: "이다연", school: "송정초", rounds: [320, 341, 344, 353], total: 1358 },
      { name: "조유리", school: "수진초", rounds: [319, 337, 350, 347], total: 1353 },
      { name: "최호희", school: "원미초", rounds: [318, 332, 352, 351], total: 1353 },
      { name: "김도희", school: "원미초", rounds: [321, 336, 342, 349], total: 1348 },
      { name: "강연지", school: "송정초", rounds: [326, 329, 342, 350], total: 1347 },
      { name: "김태연", school: "송정초", rounds: [318, 335, 336, 351], total: 1340 },
      { name: "전다은", school: "하성초", rounds: [313, 331, 344, 349], total: 1337 },
      { name: "한윤서", school: "하성초", rounds: [331, 328, 332, 344], total: 1335 },
      { name: "곽나영", school: "원미초", rounds: [311, 326, 344, 336], total: 1317 },
      { name: "황리우", school: "천현초", rounds: [305, 325, 339, 343], total: 1312 },
      { name: "손하음", school: "타겟28양궁클럽", rounds: [306, 329, 336, 339], total: 1310 },
      { name: "최승연", school: "부천시양궁협회", rounds: [307, 316, 339, 343], total: 1305 },
      { name: "강라율", school: "송정초", rounds: [301, 319, 340, 342], total: 1302 },
      { name: "김서윤", school: "송정초", rounds: [305, 314, 337, 341], total: 1297 },
      { name: "김민채", school: "타겟28양궁클럽", rounds: [290, 327, 334, 345], total: 1296 },
      { name: "안수연", school: "서초", rounds: [309, 311, 331, 344], total: 1295 },
      { name: "차유나", school: "원미초", rounds: [310, 320, 324, 337], total: 1291 },
      { name: "신서윤", school: "송정초", rounds: [302, 324, 319, 344], total: 1289 },
      { name: "탁민서", school: "서초", rounds: [296, 320, 329, 341], total: 1286 },
      { name: "김지후", school: "서초", rounds: [302, 309, 326, 342], total: 1279 },
      { name: "김태리", school: "하성초", rounds: [298, 311, 322, 345], total: 1276 },
      { name: "조유나", school: "수진초", rounds: [292, 301, 319, 339], total: 1251 },
      { name: "박수연", school: "송정초", rounds: [297, 301, 316, 327], total: 1241 },
      { name: "오연희", school: "하성초", rounds: [280, 302, 311, 337], total: 1230 },
      { name: "장윤혜", school: "송정초", rounds: [294, 286, 320, 330], total: 1230 },
      { name: "장서하", school: "서초", rounds: [286, 293, 326, 324], total: 1229 },
      { name: "김서우", school: "수진초", rounds: [262, 304, 323, 338], total: 1227 },
      { name: "김윤하", school: "송정초", rounds: [293, 290, 311, 325], total: 1219 },
      { name: "양서인", school: "하성초", rounds: [281, 299, 314, 324], total: 1218 },
      { name: "김설", school: "서초", rounds: [270, 301, 315, 327], total: 1213 },
      { name: "강민서", school: "여흥초", rounds: [272, 288, 317, 325], total: 1202 },
      { name: "유혜인", school: "타겟28양궁클럽", rounds: [284, 295, 297, 314], total: 1190 },
      { name: "박채원", school: "부천시양궁협회", rounds: [271, 285, 308, 318], total: 1182 },
      { name: "박선우", school: "송정초", rounds: [263, 284, 313, 317], total: 1177 },
      ...
      { name: "원율", school: "여흥초", rounds: [242, 261, 308, 327], total: 1138 },
      { name: "송의나", school: "수진초", rounds: [246, 257, 307, 325], total: 1135 },
      { name: "김라윤", school: "하성초", rounds: [238, 286, 293, 311], total: 1128 },
      { name: "송하영", school: "수진초", rounds: [243, 248, 300, 331], total: 1122 },
      { name: "한지안", school: "원미초", rounds: [234, 249, 300, 307], total: 1090 },
      { name: "김민채", school: "천현초", rounds: [222, 236, 288, 307], total: 1053 },
      { name: "백가은", school: "서초", rounds: [238, 230, 272, 302], total: 1042 },
      { name: "최선", school: "서초", rounds: [231, 240, 252, 293], total: 1016 },
      { name: "조예늘", school: "하성초", rounds: [166, 242, 292, 304], total: 1004 },
      { name: "백수연", school: "여흥초", rounds: [179, 245, 252, 292], total: 968 },
      { name: "김윤서", school: "원미초", rounds: [165, 198, 258, 249], total: 870 },
      { name: "조윤서", school: "서초", rounds: [190, 230, 218, 223], total: 861 },
  ...
  },
  {
    ...
    rows: [
      { name: "안은찬", school: "성포중", rounds: [338, 322, 347, 357], total: 1364 },
      { name: "이한지", school: "신장중", rounds: [328, 313, 345, 346], total: 1332 },
      { name: "이주환", school: "원천중", rounds: [318, 329, 337, 346], total: 1330 },
      { name: "안준서", school: "원천중", rounds: [319, 327, 331, 348], total: 1325 },
      { name: "황태민", school: "하성중", rounds: [342, 303, 334, 341], total: 1320 },
      { name: "손우주", school: "수원시양궁협회", rounds: [324, 308, 331, 350], total: 1313 },
      { name: "서은민", school: "성포중", rounds: [328, 297, 333, 348], total: 1306 },
      { name: "권종영", school: "원천중", rounds: [319, 302, 337, 345], total: 1303 },
      { name: "홍지훈", school: "성포중", rounds: [307, 319, 331, 341], total: 1298 },
      { name: "강민국", school: "신장중", rounds: [310, 320, 320, 348], total: 1298 },
      { name: "박민교", school: "성포중", rounds: [317, 304, 333, 341], total: 1295 },
      { name: "김준혁", school: "성포중", rounds: [320, 295, 336, 343], total: 1294 },
      { name: "최준혁", school: "남중", rounds: [316, 299, 322, 340], total: 1277 },
      { name: "진민오", school: "원천중", rounds: [318, 297, 317, 335], total: 1267 },
      { name: "정태준", school: "원천중", rounds: [312, 298, 314, 334], total: 1258 },
      { name: "김보형", school: "수원시양궁협회", rounds: [310, 264, 312, 328], total: 1214 },
      { name: "명지훈", school: "성포중", rounds: [305, 260, 302, 333], total: 1200 },
      { name: "황시윤", school: "성포중", rounds: [295, 272, 299, 323], total: 1189 },
      { name: "강지석", school: "남중", rounds: [295, 263, 307, 311], total: 1176 },
      { name: "원동우", school: "하성중", rounds: [275, 256, 306, 324], total: 1161 },
      { name: "오태윤", school: "성포중", rounds: [281, 250, 299, 321], total: 1151 },
      { name: "양희종", school: "플랜비스포츠", rounds: [298, 236, 275, 308], total: 1117 },
      { name: "이찬희", school: "신장중", rounds: [296, 224, 284, 308], total: 1112 },
      { name: "차준", school: "남중", rounds: [224, 205, 287, 304], total: 1020 },
    ],
  },
  {
    ...
    distances: [60, 50, 40, 30],
    rows: [
      { name: "장예진", school: "여흥중", rounds: [331, 324, 339, 351], total: 1345 },
      { name: "김주은", school: "창용중", rounds: [331, 326, 331, 349], total: 1337 },
      { name: "김연아", school: "창용중", rounds: [324, 305, 335, 352], total: 1316 },
      { name: "박예주", school: "창용중", rounds: [322, 313, 334, 344], total: 1313 },
      { name: "윤도경", school: "여흥중", rounds: [313, 315, 338, 347], total: 1313 },
      { name: "안지현", school: "창용중", rounds: [327, 306, 331, 345], total: 1309 },
      { name: "주혜인", school: "창용중", rounds: [329, 299, 335, 344], total: 1307 },
      { name: "최세진", school: "창용중", rounds: [316, 306, 330, 344], total: 1296 },
      { name: "윤소미", school: "신장중", rounds: [316, 290, 341, 339], total: 1286 },
      { name: "권수연", school: "상도중", rounds: [328, 272, 338, 348], total: 1286 },
      { name: "허정아", school: "하성중", rounds: [317, 301, 321, 341], total: 1280 },
      { name: "김보현", school: "여흥중", rounds: [310, 311, 317, 341], total: 1279 },
      { name: "이민솔", school: "신장중", rounds: [317, 290, 328, 342], total: 1277 },
      { name: "이가은", school: "수원시양궁협회", rounds: [315, 296, 322, 335], total: 1268 },
      { name: "한세빈", school: "창용중", rounds: [312, 296, 323, 337], total: 1268 },
      { name: "김수연", school: "창용중", rounds: [307, 298, 324, 337], total: 1266 },
      { name: "한새론", school: "창용중", rounds: [296, 308, 323, 334], total: 1261 },
      { name: "이송희", school: "서중", rounds: [302, 288, 328, 337], total: 1255 },
      { name: "김정용", school: "창용중", rounds: [300, 292, 315, 346], total: 1253 },
      { name: "유수진", school: "여흥중", rounds: [304, 285, 312, 339], total: 1240 },
      { name: "유하은", school: "하성중", rounds: [308, 284, 317, 328], total: 1237 },
      { name: "유하원", school: "상도중", rounds: [291, 289, 318, 334], total: 1232 },
      { name: "이소연", school: "창용중", rounds: [292, 272, 312, 345], total: 1221 },
      { name: "김하늘", school: "상도중", rounds: [274, 265, 316, 330], total: 1185 },
      { name: "소리아", school: "상도중", rounds: [287, 289, 272, 325], total: 1173 },
      { name: "권우솔", school: "상도중", rounds: [279, 260, 306, 319], total: 1164 },
      { name: "석지우", school: "하성중", rounds: [289, 256, 296, 320], total: 1161 },
      { name: "윤이나", school: "창용중", rounds: [289, 255, 288, 322], total: 1154 },
      { name: "함소이", school: "여흥중", rounds: [292, 215, 291, 322], total: 1120 },
      { name: "고나연", school: "여흥중", rounds: [268, 227, 305, 301], total: 1101 },
      { name: "김지윤", school: "여흥중", rounds: [282, 243, 229, 318], total: 1072 },
      { name: "김혜림", school: "서중", rounds: [254, 222, 283, 300], total: 1059 },
      { name: "김세아", school: "서중", rounds: [265, 223, 271, 300], total: 1059 },
      { name: "김하은", school: "여흥중", rounds: [120, 58, 234, 249], total: 661 },
      { name: "최아영", school: "창성중", rounds: [0, 0, 212, 293], total: 505 },
      { name: "전서연", school: "창성중", rounds: [0, 0, 203, 255], total: 458 },
    ],
  }
  ,
  {
    ...
    rows: [
      ...
      { name: "백수연", school: "여흥초", rounds: [202, 270, 275, 320], total: 1067 },
      { name: "김윤서", school: "원미초", rounds: [195, 255, 290, 301], total: 1041 },
      { name: "박가은", school: "서초", rounds: [165, 216, 273, 288], total: 942 },
      { name: "김민채", school: "천현초", rounds: [225, 213, 250, 243], total: 931 },
      { name: "조예슬", school: "하성초", rounds: [189, 203, 250, 278], total: 920 },
      { name: "윤이진", school: "여흥초", rounds: [145, 194, 231, 307], total: 877 },
      { name: "고은", school: "서초", rounds: [177, 212, 229, 255], total: 873 },
      { name: "황리안", school: "천현초", rounds: [159, 152, 209, 245], total: 765 },
      { name: "이주아", school: "서초", rounds: [65, 138, 117, 184], total: 504 }
...
,
  {
    ...
    distances: [50],
    rows: [
      { name: "김혜윤", school: "여중", rounds: [330], total: 330 }
    ],
  }
,
  {
...
,
  {
    ...
    distances: [30, 60],
    rows: [
      { name: "김혜윤", school: "여중", rounds: [347, 339], total: 686 }
    ],
  }
,
  {
    ...
    distances: [40],
    rows: [
      { name: "한정연", school: "여중", rounds: [339], total: 339 }
    ],
  }
,
  {
...
,
  {
    ...
    distances: [60],
    rows: [
      { name: "박규필", school: "체육중", rounds: [350], total: 350 }
    ],
  }
,
  {
    ...
    distances: [40],
    rows: [
      { name: "한정연", school: "여중", rounds: [353], total: 353 }
    ],
  }
,
  {
    ...
    distances: [35],
    rows: [
      { name: "양가온", school: "송현초", rounds: [348], total: 348 }
    ],
  }
,
  {
    ...
    distances: [20],
    rows: [
      { name: "신동주", school: "이원초", rounds: [360], total: 360 }
    ],
  }
,
  {
...
,
  {
    ...
    distances: [40],
    rows: [
      { name: "강민우", school: "남중", rounds: [350], total: 350 }
    ],
  }
,
  {
...
,
  {
    ...
    distances: [30],
    rows: [
      { name: "최준혁", school: "남중", rounds: [353], total: 353 },
...
,
  {
    ...
    distances: [40],
    rows: [
      { name: "한정연", school: "여중", rounds: [346], total: 346 }
    ],
  }
,
  {
...
,
  {
    ...
    distances: [50, 60],
    rows: [
      { name: "김혜윤", school: "여중", rounds: [336, 342], total: 678 }
    ],
  }
,
  {
    ...
    distances: [30],
    rows: [
      { name: "김지율", school: "여중", rounds: [357], total: 357 }
    ],
  }
,
  {
    ...
    distances: [30, 40, 50],
    rows: [
      { name: "강수정", school: "체중", rounds: [355, 346, 335], total: 1036 }
    ],
  }
,
  {
    ...
    distances: [40],
    rows: [
      { name: "김현서", school: "체중", rounds: [346], total: 346 }
    ],
  }
,
  {
...
,
  {
    ...
    distances: [50],
    rows: [
      { name: "김준서", school: "체중", rounds: [341], total: 341 }
    ],
  }
,
  {
    ...
    distances: [30, 40, 50, 60],
    rows: [
      { name: "강수정", school: "체중", rounds: [359, 349, 335, 337], total: 1380 }
    ],
  }
...
,
  ...
  },
  {
    ...
    distances: [35, 30, 25, 20],
    rows: [
      { name: "원서아", school: "하성초", division: "초등부(고학년)", rounds: [339, 342, 344, 351], total: 1376 },
      { name: "진혜민", school: "모덕초", division: "초등부(고학년)", rounds: [309, 324, 333, 340], total: 1306 },
      { name: "박교금", school: "동부초", division: "초등부(저학년)", rounds: [298, 312, 331, 340], total: 1281 },
      { name: "남유주", school: "방이초", division: "초등부(고학년)", rounds: [284, 317, 337, 327], total: 1265 },
      { name: "전혜수", school: "용성초", division: "초등부(고학년)", rounds: [287, 316, 332, 329], total: 1264 },
      { name: "표하린", school: "신계초", division: "초등부(고학년)", rounds: [292, 308, 325, 337], total: 1262 },
      { name: "이채윤", school: "모덕초", division: "초등부(고학년)", rounds: [296, 310, 317, 332], total: 1255 },
      { name: "박수빈", school: "진해중앙초", division: "초등부(고학년)", rounds: [292, 312, 317, 320], total: 1241 },
      { name: "이혜진", school: "이원초", division: "초등부(고학년)", rounds: [270, 314, 315, 337], total: 1236 },
      { name: "정하민", school: "정평초", division: "초등부(고학년)", rounds: [289, 283, 323, 332], total: 1227 },
      { name: "김루하", school: "성남초", division: "초등부(고학년)", rounds: [284, 310, 309, 322], total: 1225 },
      { name: "최지원", school: "동부초", division: "초등부(고학년)", rounds: [275, 289, 313, 325], total: 1202 },
      { name: "고채나", school: "서면초", division: "초등부(고학년)", rounds: [267, 307, 308, 314], total: 1196 },
      { name: "장예담", school: "성남초", division: "초등부(고학년)", rounds: [271, 289, 302, 330], total: 1192 },
      { name: "김지율", school: "신동초", division: "초등부(고학년)", rounds: [246, 295, 306, 315], total: 1162 },
      { name: "황서현", school: "정평초", division: "초등부(고학년)", rounds: [265, 264, 298, 324], total: 1151 },
      { name: "이효민", school: "홍남초", division: "초등부(고학년)", rounds: [287, 291, 281, 291], total: 1150 },
      { name: "정세영", school: "갈월초", division: "초등부(고학년)", rounds: [259, 267, 301, 315], total: 1142 },
      { name: "허선율", school: "문성초", division: "초등부(고학년)", rounds: [247, 277, 297, 312], total: 1133 },
      { name: "이다은", school: "두암초", division: "초등부(고학년)", rounds: [256, 261, 290, 296], total: 1103 },
      { name: "김민주", school: "여흥초", division: "초등부(고학년)", rounds: [217, 268, 309, 304], total: 1098 },
      { name: "장하연", school: "일로초", division: "초등부(고학년)", rounds: [229, 267, 269, 290], total: 1055 },
      { name: "허정여", school: "오수초", division: "초등부(고학년)", rounds: [212, 224, 295, 314], total: 1045 },
      { name: "이다연", school: "신동초", division: "초등부(고학년)", rounds: [193, 260, 251, 306], total: 1010 },
      { name: "서담비", school: "사천초", division: "초등부(고학년)", rounds: [231, 217, 252, 294], total: 994 },
      { name: "김희원", school: "신학초", division: "초등부(고학년)", rounds: [218, 225, 263, 283], total: 989 },
      { name: "박소율", school: "유촌초", division: "초등부(고학년)", rounds: [185, 222, 288, 286], total: 981 },
      { name: "최가온", school: "오수초", division: "초등부(고학년)", rounds: [177, 240, 225, 280], total: 922 },
      { name: "정해담", school: "덕벌초", division: "초등부(고학년)", rounds: [174, 220, 234, 239], total: 867 }
    ],
  },
  {
    ...
    distances: [60, 50, 40, 30],
    rows: [
      { name: "김준서", school: "체육중", division: "중등부", rounds: [339, 335, 349, 352], total: 1375 },
      { name: "박민혁", school: "북인천중", division: "중등부", rounds: [344, 337, 343, 351], total: 1375 },
      { name: "안은찬", school: "성포중", division: "중등부", rounds: [346, 330, 348, 349], total: 1373 },
      { name: "유지백", school: "병천중", division: "고등부", rounds: [343, 331, 341, 357], total: 1372 },
      { name: "최윤찬", school: "미리벌중", division: "중등부", rounds: [335, 328, 348, 356], total: 1367 },
      { name: "강유석", school: "대청중", division: "고등부", rounds: [332, 332, 344, 348], total: 1356 },
      { name: "강민우", school: "동진중", division: "중등부", rounds: [330, 332, 342, 348], total: 1352 },
      { name: "서준용", school: "동진중", division: "중등부", rounds: [333, 327, 338, 353], total: 1351 },
      { name: "변승민", school: "봉원중", division: "중등부", rounds: [340, 319, 338, 354], total: 1351 },
      { name: "주영진", school: "이원중", division: "중등부", rounds: [333, 321, 340, 355], total: 1349 },
      { name: "이재준", school: "체육중", division: "중등부", rounds: [337, 323, 332, 354], total: 1346 },
      { name: "박규필", school: "체육중", division: "중등부", rounds: [350, 324, 331, 341], total: 1346 },
      { name: "정시우", school: "성포중", division: "고등부", rounds: [331, 325, 339, 349], total: 1344 },
      { name: "김호균", school: "하성중", division: "고등부", rounds: [327, 331, 336, 348], total: 1342 },
      { name: "전용현", school: "방이중", division: "고등부", rounds: [324, 323, 343, 350], total: 1340 },
      { name: "김시온", school: "관악중", division: "중등부", rounds: [334, 326, 334, 346], total: 1340 },
      { name: "김형호", school: "무거중", division: "중등부", rounds: [338, 323, 334, 345], total: 1340 },
      { name: "이호진", school: "체육중", division: "중등부", rounds: [329, 321, 340, 348], total: 1338 },
      { name: "곽동범", school: "대서중", division: "고등부", rounds: [341, 327, 320, 347], total: 1335 },
      { name: "손민서", school: "불로중", division: "중등부", rounds: [334, 324, 328, 349], total: 1335 },
      { name: "강동주", school: "무거중", division: "고등부", rounds: [336, 315, 335, 348], total: 1334 },
      { name: "최봉석", school: "예천중", division: "고등부", rounds: [333, 317, 338, 346], total: 1334 },
      { name: "오승준", school: "이원중", division: "고등부", rounds: [337, 329, 324, 344], total: 1334 },
      { name: "윤성빈", school: "면목중", division: "고등부", rounds: [327, 322, 334, 349], total: 1332 },
      { name: "박세현", school: "북인천중", division: "고등부", rounds: [324, 320, 339, 349], total: 1332 },
      { name: "박지웅", school: "불로중", division: "중등부", rounds: [329, 323, 340, 340], total: 1332 },
      { name: "최준혁", school: "남중", division: "중등부", rounds: [327, 317, 334, 353], total: 1331 },
      { name: "서준영", school: "괴산중", division: "중등부", rounds: [336, 316, 331, 345], total: 1328 },
      { name: "정현우", school: "방이중", division: "중등부", rounds: [333, 323, 331, 341], total: 1328 },
      { name: "안현준", school: "예천중", division: "중등부", rounds: [334, 319, 332, 339], total: 1324 },
      { name: "박민혁", school: "모라중", division: "중등부", rounds: [340, 309, 335, 339], total: 1323 },
      { name: "김도겸", school: "서야중", division: "중등부", rounds: [323, 320, 337, 342], total: 1322 },
      { name: "장영한", school: "용하중", division: "중등부", rounds: [321, 309, 341, 350], total: 1321 },
      { name: "변현빈", school: "선인중", division: "고등부", rounds: [332, 318, 324, 347], total: 1321 },
      { name: "유창현", school: "내동중", division: "고등부", rounds: [332, 316, 324, 344], total: 1316 },
      { name: "이상원", school: "서야중", division: "고등부", rounds: [323, 323, 326, 344], total: 1316 },
      { name: "장대한", school: "용하중", division: "고등부", rounds: [321, 310, 334, 350], total: 1315 },
      { name: "최우석", school: "대청중", division: "고등부", rounds: [327, 320, 323, 343], total: 1313 },
      { name: "신수환", school: "온고을중", division: "고등부", rounds: [323, 309, 335, 343], total: 1310 },
      { name: "조강민", school: "풍덕중", division: "중등부", rounds: [326, 300, 338, 344], total: 1308 },
      { name: "이체현", school: "온고을중", division: "중등부", rounds: [321, 323, 314, 350], total: 1308 },
      { name: "전소익", school: "온고을중", division: "중등부", rounds: [324, 307, 342, 334], total: 1307 },
      { name: "이진율", school: "불로중", division: "중등부", rounds: [330, 312, 323, 342], total: 1307 },
      { name: "김승현", school: "용성중", division: "중등부", rounds: [318, 318, 325, 344], total: 1305 },
      { name: "서하랑", school: "운리중", division: "고등부", rounds: [319, 300, 336, 349], total: 1304 },
      { name: "임찬혁", school: "만수북중", division: "중등부", rounds: [324, 306, 328, 344], total: 1302 },
      { name: "명한결", school: "문수중", division: "고등부", rounds: [319, 293, 340, 348], total: 1300 },
      { name: "최성민", school: "모라중", division: "고등부", rounds: [318, 298, 331, 345], total: 1292 },
      { name: "문보량", school: "내동중", division: "중등부", rounds: [321, 299, 329, 337], total: 1286 },
      { name: "한승제", school: "체육중", division: "고등부", rounds: [316, 306, 319, 341], total: 1282 },
      { name: "조여준", school: "체육중", division: "중등부", rounds: [325, 306, 325, 325], total: 1281 },
      { name: "김강민", school: "무거중", division: "고등부", rounds: [309, 300, 322, 343], total: 1274 },
      { name: "황수용", school: "구례중", division: "중등부", rounds: [304, 297, 323, 345], total: 1269 },
      { name: "황준우", school: "풍덕중", division: "중등부", rounds: [319, 279, 331, 337], total: 1266 },
      { name: "유민재", school: "제주양궁클럽1", division: "중등부", rounds: [297, 303, 320, 344], total: 1264 },
      { name: "윤창현", school: "둔내중", division: "중등부", rounds: [314, 299, 307, 328], total: 1248 },
      { name: "이채호", school: "온고을중", division: "고등부", rounds: [302, 302, 314, 321], total: 1239 },
      { name: "전성은", school: "병천중", division: "중등부", rounds: [300, 296, 300, 326], total: 1222 },
      { name: "나근도", school: "북원중", division: "고등부", rounds: [309, 267, 310, 329], total: 1215 },
      { name: "배민석", school: "무거중", division: "고등부", rounds: [292, 267, 292, 322], total: 1173 },
      { name: "곽우승", school: "연일중", division: "고등부", rounds: [327, 230, 284, 328], total: 1169 },
  ...
  },
  {
    ...
    distances: [60, 50, 40, 30],
    rows: [
      { name: "강수정", school: "체육중", division: "고등부", rounds: [343, 328, 348, 354], total: 1373 },
      { name: "김가영", school: "체육중", division: "고등부", rounds: [340, 331, 350, 352], total: 1373 },
      { name: "김아현", school: "신흥여중", division: "고등부", rounds: [342, 331, 345, 354], total: 1372 },
      { name: "우소민", school: "미리벌중", division: "중등부", rounds: [332, 335, 350, 353], total: 1370 },
      { name: "이지원", school: "성화중", division: "고등부", rounds: [334, 331, 349, 356], total: 1370 },
      { name: "김예린", school: "신흥여중", division: "고등부", rounds: [332, 341, 342, 355], total: 1370 },
      { name: "김수민", school: "모라중", division: "고등부", rounds: [344, 337, 341, 347], total: 1369 },
      { name: "김은찬", school: "창용중", division: "고등부", rounds: [327, 335, 348, 355], total: 1365 },
      { name: "한정연", school: "여중", division: "고등부", rounds: [323, 333, 353, 353], total: 1362 },
      { name: "이효민", school: "체육중", division: "중등부", rounds: [325, 330, 339, 357], total: 1351 },
      { name: "이한나", school: "중원중", division: "중등부", rounds: [326, 336, 343, 346], total: 1351 },
      { name: "강현아", school: "신흥여중", division: "중등부", rounds: [333, 326, 338, 353], total: 1350 },
      { name: "조여민", school: "솔빛중", division: "중등부", rounds: [330, 329, 339, 347], total: 1345 },
      { name: "김주아", school: "여중", division: "중등부", rounds: [335, 323, 342, 344], total: 1344 },
      { name: "오선영", school: "강화여중", division: "중등부", rounds: [333, 325, 328, 356], total: 1342 },
      { name: "이주은", school: "성사중", division: "중등부", rounds: [334, 312, 345, 348], total: 1339 },
      { name: "박수연", school: "체육중", division: "중등부", rounds: [328, 319, 342, 348], total: 1337 },
      { name: "이현주", school: "창성중", division: "고등부", rounds: [312, 326, 346, 352], total: 1336 },
      { name: "송수지", school: "남천중", division: "중등부", rounds: [328, 321, 339, 348], total: 1336 },
      { name: "김혜윤", school: "여중", division: "고등부", rounds: [336, 319, 336, 344], total: 1335 },
      { name: "박가연", school: "모라중", division: "중등부", rounds: [330, 331, 331, 343], total: 1335 },
      { name: "고하린", school: "대청중", division: "고등부", rounds: [335, 316, 336, 344], total: 1331 },
      { name: "손시언", school: "진해여중", division: "중등부", rounds: [325, 317, 337, 350], total: 1329 },
      { name: "채수현", school: "체육중", division: "중등부", rounds: [331, 308, 340, 349], total: 1328 },
      { name: "임서현", school: "오창중", division: "중등부", rounds: [333, 314, 331, 349], total: 1327 },
      { name: "심예인", school: "동명중", division: "중등부", rounds: [324, 317, 337, 347], total: 1325 },
      { name: "이경민", school: "동명중", division: "중등부", rounds: [322, 319, 338, 345], total: 1324 },
      { name: "김현서", school: "체육중", division: "중등부", rounds: [322, 322, 335, 345], total: 1324 },
      { name: "임예율", school: "성화중", division: "고등부", rounds: [322, 318, 336, 347], total: 1323 },
      { name: "윤노을", school: "대청중", division: "중등부", rounds: [329, 305, 333, 355], total: 1322 },
      { name: "강선우", school: "동명중", division: "고등부", rounds: [323, 326, 329, 344], total: 1322 },
      { name: "이마리", school: "체육중", division: "고등부", rounds: [323, 314, 337, 347], total: 1321 },
      { name: "이하은", school: "남천중", division: "중등부", rounds: [320, 313, 338, 349], total: 1320 },
      { name: "서지우", school: "솔빛중", division: "고등부", rounds: [317, 316, 337, 345], total: 1315 },
      { name: "신혜민", school: "면목중", division: "고등부", rounds: [318, 318, 334, 345], total: 1315 },
      { name: "우가람", school: "용암중", division: "중등부", rounds: [326, 314, 327, 345], total: 1312 },
      { name: "이세은", school: "용암중", division: "중등부", rounds: [322, 311, 326, 348], total: 1307 },
      { name: "신주하", school: "성사중", division: "중등부", rounds: [324, 296, 336, 347], total: 1303 },
      { name: "장인영", school: "여중", division: "중등부", rounds: [317, 304, 333, 348], total: 1302 },
      { name: "이소현", school: "하랑중", division: "중등부", rounds: [315, 302, 338, 346], total: 1301 },
      { name: "유예린", school: "솔빛중", division: "고등부", rounds: [319, 318, 317, 346], total: 1300 },
      { name: "정지민", school: "병천중", division: "고등부", rounds: [324, 295, 333, 339], total: 1291 },
      { name: "이선영", school: "여중", division: "중등부", rounds: [320, 298, 328, 342], total: 1288 },
      { name: "박소희", school: "솔빛중", division: "고등부", rounds: [311, 305, 324, 344], total: 1284 },
      { name: "이서현", school: "스포츠과학중", division: "고등부", rounds: [320, 303, 318, 341], total: 1282 },
      { name: "박소을", school: "양화중", division: "중등부", rounds: [309, 310, 330, 330], total: 1279 },
      { name: "윤예진", school: "여중", division: "중등부", rounds: [309, 293, 333, 344], total: 1279 },
      { name: "이서현", school: "봉원중", division: "고등부", rounds: [315, 290, 326, 346], total: 1277 },
      { name: "이시원", school: "스포츠과학중", division: "중등부", rounds: [307, 286, 331, 350], total: 1274 },
      { name: "박소민", school: "성화중", division: "중등부", rounds: [318, 299, 321, 336], total: 1274 },
      { name: "김재이", school: "여중", division: "고등부", rounds: [305, 292, 340, 335], total: 1272 },
      { name: "정소영", school: "스포츠과학중", division: "중등부", rounds: [319, 299, 319, 335], total: 1272 },
      { name: "윤소희", school: "하랑중", division: "고등부", rounds: [305, 297, 324, 344], total: 1270 },
      { name: "조현아", school: "버들중", division: "중등부", rounds: [327, 295, 316, 330], total: 1268 },
      { name: "임나연", school: "스포츠과학중", division: "고등부", rounds: [312, 276, 334, 339], total: 1261 },
      { name: "박하연", school: "문수중", division: "중등부", rounds: [319, 279, 323, 339], total: 1260 },
      { name: "이서은", school: "체육중", division: "중등부", rounds: [311, 271, 315, 326], total: 1223 },
      { name: "최예원", school: "경포중", division: "고등부", rounds: [308, 266, 325, 317], total: 1216 },
      { name: "최다은", school: "진해여중", division: "중등부", rounds: [292, 289, 291, 324], total: 1196 },
      ...
      { name: "유민영", school: "체육중", division: "중등부", rounds: [264, 241, 297, 326], total: 1128 }
    ],
  },
  {
  ...
  },
  {
    ...
    distances: [70, 60, 50, 30],
    rows: [
      { name: "김민정", school: "체고", division: "고등부", rounds: [327, 344, 343, 351], total: 1365 },
      { name: "유슬하", school: "체고", division: "대학부", rounds: [334, 338, 336, 351], total: 1359 },
      { name: "강민진", school: "여고", division: "대학부", rounds: [340, 337, 329, 351], total: 1357 },
      { name: "남지현", school: "체고", division: "대학부", rounds: [331, 336, 335, 353], total: 1355 },
      { name: "김예원", school: "여강고", division: "고등부", rounds: [333, 339, 333, 350], total: 1355 },
      { name: "양가은", school: "부개고", division: "고등부", rounds: [335, 331, 332, 356], total: 1354 },
      { name: "한지예", school: "체고", division: "고등부", rounds: [338, 336, 330, 348], total: 1352 },
      { name: "윤수희", school: "체고", division: "대학부", rounds: [334, 336, 327, 354], total: 1351 },
      { name: "이가영", school: "여고", division: "고등부", rounds: [337, 333, 333, 348], total: 1351 },
      { name: "구슬", school: "체고", division: "고등부", rounds: [335, 336, 328, 350], total: 1349 },
      { name: "조한이", school: "여고", division: "대학부", rounds: [334, 343, 319, 352], total: 1348 },
      { name: "정서은", school: "여고", division: "고등부", rounds: [331, 336, 335, 345], total: 1347 },
      { name: "김정은", school: "체고", division: "고등부", rounds: [327, 335, 331, 354], total: 1347 },
      { name: "황하정", school: "체고", division: "대학부", rounds: [327, 338, 326, 352], total: 1343 },
      { name: "김하은", school: "체고", division: "대학부", rounds: [329, 338, 329, 347], total: 1343 },
      { name: "이경현", school: "체고", division: "고등부", rounds: [328, 333, 331, 351], total: 1343 },
      { name: "양다혜", school: "진해여고", division: "고등부", rounds: [331, 340, 324, 347], total: 1342 },
      { name: "김나은", school: "여고", division: "고등부", rounds: [333, 331, 325, 351], total: 1340 },
      { name: "장보슬", school: "여고", division: "대학부", rounds: [331, 334, 320, 353], total: 1338 },
      { name: "구보름", school: "체고", division: "고등부", rounds: [327, 332, 330, 348], total: 1337 },
      { name: "이주예", school: "성문고", division: "대학부", rounds: [332, 331, 326, 347], total: 1336 },
      { name: "박효빈", school: "체고", division: "대학부", rounds: [333, 341, 321, 341], total: 1336 },
      { name: "박세빈", school: "체고", division: "고등부", rounds: [324, 337, 331, 343], total: 1335 },
      { name: "전지현", school: "체고", division: "고등부", rounds: [323, 335, 331, 346], total: 1335 },
      { name: "강은지", school: "체고", division: "고등부", rounds: [322, 336, 327, 349], total: 1334 },
      { name: "이채은", school: "체고", division: "고등부", rounds: [318, 339, 326, 351], total: 1334 },
      { name: "장혜주", school: "여고", division: "고등부", rounds: [328, 332, 327, 347], total: 1334 },
      { name: "이연우", school: "체고", division: "대학부", rounds: [323, 342, 320, 349], total: 1334 },
      { name: "김가을", school: "체고", division: "고등부", rounds: [324, 333, 326, 349], total: 1332 },
      { name: "김민서", school: "체고", division: "고등부", rounds: [325, 335, 324, 348], total: 1332 },
      { name: "송하린", school: "체고", division: "고등부", rounds: [314, 344, 331, 342], total: 1331 },
      { name: "양태희", school: "체고", division: "고등부", rounds: [329, 328, 323, 350], total: 1330 },
      { name: "김수연", school: "제주양궁클럽1", division: "고등부", rounds: [324, 337, 321, 348], total: 1330 },
      { name: "정수연", school: "부개고", division: "고등부", rounds: [324, 339, 322, 344], total: 1329 },
      { name: "윤가영", school: "여고", division: "고등부", rounds: [326, 331, 321, 350], total: 1328 },
      { name: "김하나", school: "여고", division: "고등부", rounds: [319, 333, 326, 350], total: 1328 },
      { name: "서희예", school: "체고", division: "대학부", rounds: [322, 331, 332, 342], total: 1327 },
      { name: "김세아", school: "스포츠과학고", division: "고등부", rounds: [321, 336, 329, 339], total: 1325 },
      { name: "김정빈", school: "체고", division: "고등부", rounds: [322, 324, 325, 353], total: 1324 },
      { name: "김지원", school: "체고", division: "고등부", rounds: [318, 330, 327, 349], total: 1324 },
      { name: "김지은", school: "진해여고", division: "고등부", rounds: [313, 332, 333, 346], total: 1324 },
      { name: "김도영", school: "체고", division: "대학부", rounds: [325, 337, 316, 345], total: 1323 },
      { name: "김시우", school: "여고", division: "대학부", rounds: [321, 333, 316, 352], total: 1322 },
      { name: "정세리", school: "진해여고", division: "고등부", rounds: [322, 333, 324, 341], total: 1320 },
      { name: "배현지", school: "체고", division: "고등부", rounds: [326, 335, 310, 345], total: 1316 },
      { name: "최윤서", school: "체고", division: "고등부", rounds: [323, 325, 321, 346], total: 1315 },
      { name: "정유정", school: "체고", division: "대학부", rounds: [315, 334, 316, 349], total: 1314 },
      { name: "김정연", school: "체고", division: "대학부", rounds: [315, 335, 314, 349], total: 1313 },
      { name: "박민지", school: "부개고", division: "대학부", rounds: [324, 322, 320, 347], total: 1313 },
      { name: "신여은", school: "체고", division: "고등부", rounds: [326, 328, 317, 341], total: 1312 },
      { name: "나윤경", school: "스포츠과학고", division: "고등부", rounds: [322, 332, 315, 343], total: 1312 },
      { name: "장율리", school: "스포츠과학고", division: "대학부", rounds: [318, 328, 321, 345], total: 1312 },
      { name: "김봄", school: "여고", division: "대학부", rounds: [322, 320, 321, 348], total: 1311 },
      { name: "김서윤", school: "부개고", division: "고등부", rounds: [310, 330, 320, 350], total: 1310 },
      { name: "김예인", school: "체고", division: "고등부", rounds: [308, 323, 325, 352], total: 1308 },
      { name: "배소윤", school: "체고", division: "고등부", rounds: [315, 334, 317, 340], total: 1306 },
      { name: "김은지", school: "체고", division: "고등부", rounds: [311, 325, 322, 343], total: 1301 },
      { name: "라혜빈", school: "펫고", division: "고등부", rounds: [321, 329, 305, 344], total: 1299 },
      { name: "하윤진", school: "체고", division: "고등부", rounds: [314, 335, 310, 340], total: 1299 },
      { name: "하윤선", school: "체고", division: "대학부", rounds: [313, 314, 325, 347], total: 1299 },
      { name: "김하윤", school: "여고", division: "고등부", rounds: [310, 318, 319, 349], total: 1296 },
      { name: "최은", school: "체고", division: "고등부", rounds: [308, 325, 320, 343], total: 1296 },
      { name: "신서영", school: "부개고", division: "고등부", rounds: [313, 318, 323, 341], total: 1295 },
      { name: "박지율", school: "체고", division: "고등부", rounds: [306, 320, 323, 344], total: 1293 },
      { name: "김주은", school: "체고", division: "대학부", rounds: [312, 322, 318, 341], total: 1293 },
      { name: "권예랑", school: "체고", division: "대학부", rounds: [315, 321, 323, 332], total: 1291 },
      { name: "박정현", school: "체고", division: "대학부", rounds: [317, 328, 310, 333], total: 1288 },
      { name: "김민솔", school: "원주여고", division: "대학부", rounds: [307, 320, 316, 345], total: 1288 },
      { name: "김서영", school: "성문고", division: "고등부", rounds: [319, 318, 311, 337], total: 1285 },
      { name: "김서현", school: "체고", division: "고등부", rounds: [313, 315, 312, 337], total: 1277 },
      { name: "최정인", school: "체고", division: "대학부", rounds: [310, 310, 311, 345], total: 1276 },
      { name: "강주은", school: "체고", division: "고등부", rounds: [307, 316, 309, 342], total: 1274 },
      { name: "한소혜", school: "여고", division: "대학부", rounds: [321, 318, 293, 342], total: 1274 },
      { name: "박채린", school: "체고", division: "고등부", rounds: [310, 320, 294, 348], total: 1272 },
      { name: "이율아", school: "체고", division: "대학부", rounds: [313, 326, 304, 329], total: 1272 },
      { name: "고민지", school: "하성고", division: "고등부", rounds: [300, 321, 310, 337], total: 1268 },
      { name: "박가은", school: "체고", division: "대학부", rounds: [304, 328, 298, 337], total: 1267 },
      { name: "김민지", school: "체고", division: "고등부", rounds: [311, 320, 303, 330], total: 1264 },
      { name: "김소민", school: "여강고", division: "고등부", rounds: [294, 313, 307, 348], total: 1262 },
      { name: "이주언", school: "여고", division: "대학부", rounds: [308, 304, 305, 343], total: 1260 },
      { name: "이다은", school: "여고", division: "고등부", rounds: [296, 317, 300, 343], total: 1256 },
      { name: "김성령", school: "체고", division: "고등부", rounds: [294, 331, 306, 323], total: 1254 },
      { name: "이채민", school: "체고", division: "고등부", rounds: [299, 314, 295, 340], total: 1248 },
      { name: "박경빈", school: "부개고", division: "고등부", rounds: [319, 311, 279, 334], total: 1243 },
      { name: "홍다은", school: "체고", division: "고등부", rounds: [301, 301, 299, 332], total: 1233 },
      { name: "김민아", school: "진해여고", division: "고등부", rounds: [290, 305, 290, 332], total: 1217 },
      { name: "김라함", school: "체고", division: "고등부", rounds: [271, 294, 296, 334], total: 1195 },
      { name: "이연서", school: "북평여고", division: "대학부", rounds: [290, 297, 275, 332], total: 1194 },
      { name: "정서윤", school: "성남시체육회1", division: "고등부", rounds: [285, 304, 246, 325], total: 1160 },
      { name: "오시연", school: "여강고", division: "고등부", rounds: [273, 299, 268, 319], total: 1159 },
      { name: "김다연", school: "체고", division: "고등부", rounds: [259, 279, 254, 327], total: 1119 },
      { name: "엄수정", school: "원주여고", division: "고등부", rounds: [0, 0, 0, 0], total: 0 }
    ],
  },
  {
    ...
    distances: [35, 30, 25, 20],
    rows: [
      { name: "이윤기", school: "동부초", division: "초등부(고학년)", rounds: [331, 334, 343, 354], total: 1362 },
      { name: "이지호", school: "오창초", division: "초등부(고학년)", rounds: [321, 337, 330, 348], total: 1336 },
      { name: "이지원", school: "예천초", division: "초등부(고학년)", rounds: [321, 324, 332, 349], total: 1326 },
      { name: "박지후", school: "창녕초", division: "초등부(고학년)", rounds: [309, 328, 329, 351], total: 1317 },
      { name: "김도헌", school: "동부초", division: "초등부(고학년)", rounds: [315, 326, 327, 345], total: 1313 },
      { name: "김라원", school: "새일초", division: "초등부(고학년)", rounds: [305, 317, 338, 343], total: 1303 },
      { name: "김영민", school: "연무초", division: "초등부(고학년)", rounds: [309, 316, 328, 339], total: 1292 },
      { name: "이하준", school: "동부초", division: "초등부(고학년)", rounds: [307, 312, 328, 342], total: 1289 },
      { name: "김여울", school: "용성초", division: "초등부(저학년)", rounds: [300, 328, 322, 338], total: 1288 },
      { name: "김태윤", school: "예천초", division: "초등부(고학년)", rounds: [284, 320, 333, 341], total: 1278 },
      { name: "김영재", school: "연무초", division: "초등부(저학년)", rounds: [296, 310, 335, 332], total: 1273 },
      { name: "주재훈", school: "봉원초", division: "초등부(고학년)", rounds: [302, 307, 323, 335], total: 1267 },
      { name: "이시곤", school: "송촌초", division: "초등부(고학년)", rounds: [304, 302, 321, 337], total: 1264 },
      { name: "곽상우", school: "이원초", division: "초등부(저학년)", rounds: [301, 295, 331, 334], total: 1261 },
      { name: "최강빈", school: "천현초", division: "초등부(고학년)", rounds: [287, 307, 329, 336], total: 1259 },
      { name: "박찬석", school: "용현남초", division: "초등부(고학년)", rounds: [289, 317, 324, 327], total: 1257 },
      { name: "김진표", school: "부평서초", division: "초등부(고학년)", rounds: [287, 300, 330, 334], total: 1251 },
      { name: "유선유", school: "연무초", division: "초등부(저학년)", rounds: [277, 310, 322, 341], total: 1250 },
      { name: "전준표", school: "장유초", division: "초등부(고학년)", rounds: [281, 311, 324, 334], total: 1250 },
      { name: "장현우", school: "부평서초", division: "초등부(고학년)", rounds: [285, 295, 327, 341], total: 1248 },
      { name: "고태호", school: "서부초", division: "초등부(고학년)", rounds: [296, 301, 320, 330], total: 1247 },
      { name: "이승원", school: "불로초", division: "초등부(고학년)", rounds: [293, 306, 315, 332], total: 1246 },
      { name: "장재하", school: "명덕초", division: "초등부(저학년)", rounds: [284, 303, 320, 332], total: 1239 },
      { name: "고준혁", school: "예천초", division: "초등부(고학년)", rounds: [271, 310, 324, 333], total: 1238 },
      { name: "민해양", school: "봉원초", division: "초등부(고학년)", rounds: [307, 286, 313, 329], total: 1235 },
      { name: "황다겸", school: "태서초", division: "초등부(고학년)", rounds: [281, 299, 314, 336], total: 1230 },
      { name: "변지성", school: "부평서초", division: "초등부(저학년)", rounds: [280, 296, 325, 324], total: 1225 },
      { name: "김동진", school: "명륜초", division: "초등부(고학년)", rounds: [262, 295, 318, 333], total: 1208 },
      { name: "최서빈", school: "장유초", division: "초등부(고학년)", rounds: [269, 294, 309, 330], total: 1202 },
      { name: "이재용", school: "금릉초", division: "초등부(고학년)", rounds: [283, 300, 309, 304], total: 1196 },
      { name: "김호야", school: "용하초", division: "초등부(고학년)", rounds: [283, 292, 306, 311], total: 1192 },
      { name: "김지완", school: "송촌초", division: "초등부(고학년)", rounds: [262, 278, 314, 334], total: 1188 },
      { name: "조민혁", school: "설악초", division: "초등부(고학년)", rounds: [258, 296, 308, 319], total: 1181 },
      { name: "오지우", school: "모덕초", division: "초등부(고학년)", rounds: [257, 292, 302, 329], total: 1180 },
      { name: "김다온", school: "계산초", division: "초등부(고학년)", rounds: [277, 276, 290, 329], total: 1172 },
      { name: "손유빈", school: "삼정초", division: "초등부(고학년)", rounds: [256, 298, 302, 313], total: 1169 },
      { name: "윤희성", school: "개봉초", division: "초등부(고학년)", rounds: [251, 289, 310, 318], total: 1168 },
      { name: "이지호", school: "명덕초", division: "초등부(고학년)", rounds: [264, 291, 288, 321], total: 1164 },
      { name: "김상우", school: "장유초", division: "초등부(고학년)", rounds: [276, 285, 282, 321], total: 1164 },
      { name: "나하흠", school: "새일초", division: "초등부(고학년)", rounds: [284, 290, 281, 306], total: 1161 },
      { name: "박수호", school: "창녕초", division: "초등부(고학년)", rounds: [247, 289, 299, 323], total: 1158 },
      { name: "조우석", school: "개봉초", division: "초등부(고학년)", rounds: [241, 278, 308, 327], total: 1154 },
      { name: "구민준", school: "교동초", division: "초등부(고학년)", rounds: [235, 289, 291, 323], total: 1138 },
      { name: "홍석환", school: "새일초", division: "초등부(고학년)", rounds: [263, 245, 307, 316], total: 1131 },
      { name: "정연오", school: "인헌초", division: "초등부(고학년)", rounds: [239, 277, 285, 320], total: 1121 },
      { name: "박종현", school: "설악초", division: "초등부(고학년)", rounds: [248, 291, 275, 305], total: 1119 },
      { name: "이준", school: "삼정초", division: "초등부(고학년)", rounds: [223, 281, 280, 325], total: 1109 },
      { name: "이윤", school: "부평서초", division: "초등부(저학년)", rounds: [217, 280, 289, 317], total: 1103 },
      { name: "최유담", school: "태서초", division: "초등부(저학년)", rounds: [247, 272, 260, 314], total: 1093 },
      { name: "최현준", school: "플랜비스포츠4", division: "초등부(통합)", rounds: [226, 261, 290, 296], total: 1073 },
      { name: "김단우", school: "서부초", division: "초등부(고학년)", rounds: [244, 201, 300, 309], total: 1054 },
      { name: "장민준", school: "두암초", division: "초등부(고학년)", rounds: [215, 266, 258, 290], total: 1029 },
      { name: "고태환", school: "성진초", division: "초등부(고학년)", rounds: [214, 250, 279, 280], total: 1023 },
      { name: "정인후", school: "송현초", division: "초등부(고학년)", rounds: [255, 190, 281, 281], total: 1007 },
      { name: "김영웅", school: "계산초", division: "초등부(고학년)", rounds: [207, 247, 262, 283], total: 999 },
      { name: "최우빈", school: "천현초", division: "초등부(저학년)", rounds: [218, 241, 233, 275], total: 967 },
      { name: "김형진", school: "태서초", division: "초등부(고학년)", rounds: [190, 240, 264, 267], total: 961 },
      { name: "정호윤", school: "계산초", division: "초등부(고학년)", rounds: [208, 250, 242, 261], total: 961 },
      { name: "이소율", school: "봉원초", division: "초등부(고학년)", rounds: [217, 216, 235, 287], total: 955 },
      { name: "배단우", school: "개봉초", division: "초등부(고학년)", rounds: [212, 244, 232, 223], total: 911 },
      { name: "강태현", school: "태서초", division: "초등부(저학년)", rounds: [159, 234, 214, 263], total: 870 },
      { name: "이정현", school: "기린초", division: "초등부(저학년)", rounds: [0, 221, 241, 266], total: 728 },
      { name: "김강우", school: "명륜초", division: "초등부(고학년)", rounds: [0, 0, 287, 306], total: 593 },
      { name: "김현승", school: "청량초", division: "초등부(고학년)", rounds: [0, 0, 220, 231], total: 451 }
    ],
  },
  {
    ...
    distances: [90, 70, 50, 30],
    rows: [
      { name: "최철준", school: "체고", division: "대학부", rounds: [323, 342, 342, 354], total: 1361 },
      { name: "김태현", school: "효원고", division: "고등부", rounds: [315, 338, 343, 354], total: 1350 },
      { name: "조세현", school: "체고", division: "고등부", rounds: [316, 337, 337, 356], total: 1346 },
      { name: "박명재", school: "체고", division: "고등부", rounds: [317, 335, 340, 354], total: 1346 },
      { name: "송지성", school: "체고", division: "대학부", rounds: [316, 333, 338, 357], total: 1344 },
      { name: "박성우", school: "체고", division: "대학부", rounds: [327, 327, 335, 350], total: 1339 },
      { name: "조성윤", school: "체고", division: "고등부", rounds: [314, 327, 341, 356], total: 1338 },
      { name: "심유한", school: "체고", division: "고등부", rounds: [309, 334, 337, 357], total: 1337 },
      { name: "김태서", school: "체고", division: "고등부", rounds: [306, 335, 338, 355], total: 1334 },
      { name: "오예인", school: "체고", division: "고등부", rounds: [307, 334, 339, 353], total: 1333 },
      { name: "박은성", school: "체고", division: "대학부", rounds: [313, 336, 336, 348], total: 1333 },
      { name: "조성철", school: "체고", division: "대학부", rounds: [318, 336, 326, 350], total: 1330 },
      { name: "지호준", school: "체고", division: "대학부", rounds: [315, 328, 333, 353], total: 1329 },
      { name: "이희범", school: "경북고", division: "고등부", rounds: [308, 333, 339, 349], total: 1329 },
      { name: "권태연", school: "체고", division: "대학부", rounds: [312, 330, 333, 352], total: 1327 },
      { name: "이승명", school: "체고", division: "대학부", rounds: [318, 332, 333, 344], total: 1327 },
      { name: "김성용", school: "체고", division: "고등부", rounds: [307, 334, 333, 352], total: 1326 },
      { name: "김성준", school: "체고", division: "고등부", rounds: [309, 333, 330, 353], total: 1325 },
      { name: "권용민", school: "체고", division: "고등부", rounds: [315, 327, 335, 347], total: 1324 },
      { name: "장은석", school: "체고", division: "대학부", rounds: [306, 330, 336, 351], total: 1323 },
      { name: "금왕산", school: "체고", division: "고등부", rounds: [307, 330, 328, 354], total: 1319 },
      { name: "박정우", school: "체고", division: "고등부", rounds: [300, 329, 336, 354], total: 1319 },
      { name: "김범진", school: "경북고", division: "고등부", rounds: [312, 322, 333, 351], total: 1318 },
      { name: "권오율", school: "체고", division: "고등부", rounds: [310, 336, 323, 349], total: 1318 },
      { name: "여우영", school: "체고", division: "고등부", rounds: [298, 331, 334, 353], total: 1316 },
      { name: "제갈윤", school: "경북고", division: "대학부", rounds: [310, 330, 325, 347], total: 1312 },
      { name: "이태건", school: "체고", division: "고등부", rounds: [302, 334, 331, 345], total: 1312 },
      { name: "배정원", school: "체고", division: "대학부", rounds: [313, 326, 326, 347], total: 1312 },
      { name: "김동욱", school: "체고", division: "고등부", rounds: [305, 324, 328, 353], total: 1310 },
      { name: "정승욱", school: "체고", division: "고등부", rounds: [303, 329, 331, 347], total: 1310 },
      { name: "임은재", school: "영선고", division: "고등부", rounds: [298, 331, 324, 352], total: 1305 },
      { name: "김시우", school: "체고", division: "고등부", rounds: [303, 326, 330, 344], total: 1303 },
      { name: "신재원", school: "체고", division: "대학부", rounds: [310, 318, 326, 348], total: 1302 },
      { name: "성하준", school: "체고", division: "고등부", rounds: [314, 323, 316, 349], total: 1302 },
      { name: "전준희", school: "체고", division: "대학부", rounds: [293, 323, 336, 349], total: 1301 },
      { name: "송태민", school: "체고", division: "대학부", rounds: [310, 329, 314, 348], total: 1301 },
      { name: "노지원", school: "체고", division: "고등부", rounds: [301, 321, 335, 344], total: 1301 },
      { name: "김태호", school: "경북고", division: "고등부", rounds: [309, 324, 315, 351], total: 1299 },
      { name: "권재현", school: "경북고", division: "고등부", rounds: [303, 323, 323, 349], total: 1298 },
      { name: "윤동영", school: "체고", division: "고등부", rounds: [299, 320, 327, 351], total: 1297 },
      { name: "신승현", school: "체고", division: "고등부", rounds: [298, 319, 332, 348], total: 1297 },
      { name: "신민재", school: "체고", division: "고등부", rounds: [297, 319, 326, 350], total: 1292 },
      { name: "김명수", school: "효원고", division: "고등부", rounds: [304, 323, 327, 338], total: 1292 },
      { name: "한경수", school: "체고", division: "고등부", rounds: [286, 322, 331, 352], total: 1291 },
      { name: "최제웅", school: "체고", division: "고등부", rounds: [298, 327, 324, 342], total: 1291 },
      { name: "천하준", school: "서야고", division: "고등부", rounds: [291, 325, 321, 353], total: 1290 },
      { name: "김부영", school: "체고", division: "고등부", rounds: [289, 317, 334, 348], total: 1288 },
      { name: "김종연", school: "체고", division: "고등부", rounds: [294, 329, 316, 346], total: 1285 },
      { name: "주재윤", school: "효원고", division: "고등부", rounds: [297, 320, 328, 340], total: 1285 },
      { name: "신희범", school: "영선고", division: "고등부", rounds: [294, 317, 324, 349], total: 1284 },
      { name: "신재윤", school: "체고", division: "고등부", rounds: [297, 319, 318, 349], total: 1283 },
      { name: "윤성환", school: "체고", division: "대학부", rounds: [296, 309, 325, 352], total: 1282 },
      { name: "유홍현", school: "체고", division: "대학부", rounds: [301, 312, 326, 343], total: 1282 },
      { name: "김민우", school: "체고", division: "고등부", rounds: [292, 322, 320, 348], total: 1282 },
      { name: "안채빈", school: "영선고", division: "대학부", rounds: [299, 314, 330, 338], total: 1281 },
      { name: "고은찬", school: "체고", division: "고등부", rounds: [281, 317, 329, 353], total: 1280 },
      { name: "김준성", school: "체고", division: "고등부", rounds: [288, 316, 324, 352], total: 1280 },
      { name: "진은석", school: "체고", division: "대학부", rounds: [278, 330, 323, 349], total: 1280 },
      { name: "최시후", school: "체고", division: "대학부", rounds: [297, 321, 325, 336], total: 1279 },
      { name: "송석민", school: "체고", division: "고등부", rounds: [274, 322, 330, 350], total: 1276 },
      { name: "이구식", school: "체고", division: "고등부", rounds: [304, 310, 317, 343], total: 1274 },
      { name: "여상민", school: "경북고", division: "고등부", rounds: [290, 315, 319, 349], total: 1273 },
      { name: "서익언", school: "순천고", division: "고등부", rounds: [287, 328, 323, 334], total: 1272 },
      { name: "이재헌", school: "체고", division: "고등부", rounds: [288, 315, 323, 343], total: 1269 },
      { name: "이지호", school: "일고", division: "고등부", rounds: [284, 314, 326, 342], total: 1266 },
      { name: "박진호", school: "체고", division: "고등부", rounds: [307, 306, 314, 338], total: 1265 },
      { name: "강동한", school: "체고", division: "대학부", rounds: [301, 313, 309, 339], total: 1262 },
      { name: "김은찬", school: "효원고", division: "고등부", rounds: [273, 315, 323, 350], total: 1261 },
      { name: "정재웅", school: "영선고", division: "고등부", rounds: [288, 318, 312, 342], total: 1260 },
      { name: "박건호", school: "체고", division: "고등부", rounds: [276, 317, 323, 342], total: 1258 },
      { name: "윤의섭", school: "체고", division: "고등부", rounds: [268, 321, 324, 344], total: 1257 },
      { name: "윤정민", school: "체고", division: "고등부", rounds: [279, 321, 307, 349], total: 1256 },
      { name: "강연수", school: "체고", division: "고등부", rounds: [277, 325, 311, 342], total: 1255 },
      { name: "박상준", school: "일고", division: "고등부", rounds: [299, 313, 309, 333], total: 1254 },
      { name: "편서준", school: "효원고", division: "고등부", rounds: [285, 313, 310, 345], total: 1253 },
      { name: "이진혁", school: "체고", division: "고등부", rounds: [295, 318, 302, 337], total: 1252 },
      { name: "장태하", school: "체고", division: "고등부", rounds: [294, 301, 311, 344], total: 1250 },
      { name: "김성민", school: "체고", division: "대학부", rounds: [283, 302, 326, 337], total: 1248 },
      { name: "조예성", school: "체고", division: "고등부", rounds: [270, 318, 308, 346], total: 1242 },
      { name: "김규성", school: "서야고", division: "고등부", rounds: [289, 306, 309, 336], total: 1240 },
      { name: "최승원", school: "체고", division: "고등부", rounds: [291, 297, 314, 333], total: 1235 },
      { name: "김주엽", school: "체고", division: "고등부", rounds: [275, 321, 295, 339], total: 1230 },
      { name: "손영훈", school: "서야고", division: "고등부", rounds: [281, 303, 300, 346], total: 1230 },
      { name: "박주호", school: "효원고", division: "대학부", rounds: [273, 303, 304, 347], total: 1227 },
      { name: "길대현", school: "체고", division: "고등부", rounds: [261, 313, 310, 337], total: 1221 },
      { name: "박주경", school: "체고", division: "고등부", rounds: [269, 301, 301, 348], total: 1219 },
      { name: "최시윤", school: "체고", division: "고등부", rounds: [257, 308, 302, 332], total: 1199 },
      { name: "최시후", school: "체고", division: "고등부", rounds: [268, 303, 288, 337], total: 1196 },
      { name: "김은찬", school: "체고", division: "대학부", rounds: [261, 295, 304, 325], total: 1185 },
      { name: "장동영", school: "체고", division: "대학부", rounds: [265, 300, 292, 321], total: 1178 },
      { name: "김기영", school: "순천고", division: "고등부", rounds: [253, 302, 288, 333], total: 1176 },
      { name: "박현", school: "일고", division: "대학부", rounds: [252, 294, 293, 330], total: 1169 },
      { name: "김제준", school: "체고", division: "고등부", rounds: [256, 287, 300, 326], total: 1169 },
      { name: "최준원", school: "체고", division: "고등부", rounds: [267, 278, 266, 323], total: 1134 },
      { name: "고범찬", school: "체고", division: "고등부", rounds: [238, 277, 280, 325], total: 1120 },
      { name: "김명찬", school: "순천고", division: "대학부", rounds: [234, 277, 277, 326], total: 1114 },
      { name: "권태윤", school: "병천고", division: "고등부", rounds: [248, 278, 257, 323], total: 1106 }
    ],
  },
  {
    ...
    distances: [90, 70, 50, 30],
    rows: [
      { name: "민성욱", school: "한국체육대학교2", division: "대학부", rounds: [317, 342, 332, 356], total: 1347 },
      { name: "지예찬", school: "한국체육대학교1", division: "대학부", rounds: [330, 335, 327, 353], total: 1345 },
      { name: "최두희", school: "경희대학교4", division: "대학부", rounds: [319, 336, 332, 351], total: 1338 },
      { name: "김종우", school: "한국체육대학교2", division: "대학부", rounds: [318, 341, 325, 353], total: 1337 },
      { name: "박태현", school: "울산대학교2", division: "대학부", rounds: [323, 335, 331, 348], total: 1337 },
      { name: "김동훈", school: "국립경국대학교2", division: "대학부", rounds: [323, 334, 332, 347], total: 1336 },
      { name: "이효범", school: "경희대학교2", division: "대학부", rounds: [321, 339, 321, 354], total: 1335 },
      { name: "강민승", school: "계명대학교3", division: "대학부", rounds: [326, 325, 335, 349], total: 1335 },
      { name: "김동현", school: "경희대학교2", division: "대학부", rounds: [309, 341, 331, 354], total: 1335 },
      { name: "장준하", school: "계명대학교2", division: "대학부", rounds: [321, 337, 326, 350], total: 1334 },
      { name: "정호진", school: "울산대학교3", division: "대학부", rounds: [310, 333, 333, 356], total: 1332 },
      { name: "이건호", school: "배재대학교1", division: "대학부", rounds: [316, 335, 335, 345], total: 1331 },
      { name: "김정민", school: "배재대학교4", division: "대학부", rounds: [314, 336, 328, 352], total: 1330 },
      { name: "강현빈", school: "인천대학교4", division: "대학부", rounds: [317, 326, 334, 352], total: 1329 },
      { name: "구범준", school: "한국체육대학교3", division: "대학부", rounds: [315, 334, 326, 352], total: 1327 },
      { name: "최우진", school: "조선대학교1", division: "대학부", rounds: [312, 325, 335, 353], total: 1325 },
      { name: "최우석", school: "배재대학교1", division: "대학부", rounds: [305, 335, 331, 352], total: 1323 },
      { name: "김기범", school: "계명대학교1", division: "대학부", rounds: [320, 336, 323, 343], total: 1322 },
      { name: "조윤혁", school: "국립경국대학교1", division: "대학부", rounds: [311, 327, 333, 351], total: 1322 },
      { name: "김다니엘", school: "순천대학교1", division: "대학부", rounds: [308, 334, 332, 346], total: 1320 },
      { name: "최민재", school: "상지대학교2", division: "대학부", rounds: [317, 337, 314, 352], total: 1320 },
      { name: "정세윤", school: "인천대학교2", division: "대학부", rounds: [310, 334, 324, 352], total: 1320 },
      { name: "강민재", school: "서원대학교4", division: "대학부", rounds: [302, 334, 323, 356], total: 1315 },
      { name: "진효성", school: "조선대학교3", division: "대학부", rounds: [320, 326, 329, 339], total: 1314 },
      { name: "황성현", school: "서원대학교1", division: "대학부", rounds: [308, 327, 327, 350], total: 1312 },
      { name: "신준", school: "계명대학교1", division: "대학부", rounds: [311, 334, 317, 349], total: 1311 },
      { name: "채진서", school: "조선대학교4", division: "대학부", rounds: [313, 331, 313, 354], total: 1311 },
      { name: "이정한", school: "배재대학교3", division: "대학부", rounds: [305, 330, 320, 352], total: 1307 },
      { name: "조국", school: "배재대학교4", division: "대학부", rounds: [308, 336, 313, 349], total: 1306 },
      { name: "김민재", school: "한국체육대학교4", division: "대학부", rounds: [302, 334, 319, 350], total: 1305 },
      { name: "이은재", school: "한국체육대학교3", division: "대학부", rounds: [313, 338, 312, 342], total: 1305 },
      { name: "김종환", school: "국립경국대학교2", division: "대학부", rounds: [310, 328, 319, 347], total: 1304 },
      { name: "김제영", school: "한일장신대학교2", division: "대학부", rounds: [296, 325, 330, 350], total: 1301 },
      { name: "송태건", school: "국립경국대학교3", division: "대학부", rounds: [302, 328, 326, 345], total: 1301 },
      { name: "현상우", school: "서원대학교3", division: "대학부", rounds: [299, 332, 323, 346], total: 1300 },
      { name: "이승우", school: "국립경국대학교4", division: "대학부", rounds: [310, 324, 318, 346], total: 1298 },
      { name: "조대신", school: "인천대학교3", division: "대학부", rounds: [296, 328, 321, 352], total: 1297 },
      { name: "장우혁", school: "한일장신대학교1", division: "대학부", rounds: [302, 325, 321, 349], total: 1297 },
      { name: "김택중", school: "한국체육대학교1", division: "대학부", rounds: [297, 327, 327, 342], total: 1293 },
      { name: "박라이", school: "한일장신대학교1", division: "대학부", rounds: [300, 324, 322, 344], total: 1290 },
      { name: "박훈정", school: "배재대학교2", division: "대학부", rounds: [301, 323, 319, 346], total: 1289 },
      { name: "조민수", school: "조선대학교2", division: "대학부", rounds: [309, 321, 313, 346], total: 1289 },
      { name: "강우석", school: "국립경국대학교3", division: "대학부", rounds: [276, 323, 330, 353], total: 1282 },
      { name: "이정원", school: "한일장신대학교3", division: "대학부", rounds: [292, 330, 307, 350], total: 1279 },
      { name: "고성훈", school: "서원대학교1", division: "대학부", rounds: [281, 314, 328, 351], total: 1274 },
      { name: "김선혁", school: "한국체육대학교3", division: "대학부", rounds: [288, 320, 316, 346], total: 1270 },
      { name: "강민서", school: "국립경국대학교1", division: "대학부", rounds: [297, 324, 307, 340], total: 1268 },
      { name: "송현태", school: "서원대학교2", division: "대학부", rounds: [289, 322, 312, 335], total: 1258 },
      { name: "이찬주", school: "한국체육대학교2", division: "대학부", rounds: [294, 326, 307, 325], total: 1252 },
      { name: "심태한", school: "조선대학교1", division: "대학부", rounds: [284, 315, 313, 333], total: 1245 },
      { name: "최지섭", school: "상지대학교2", division: "대학부", rounds: [296, 299, 307, 340], total: 1242 },
      { name: "유정현", school: "상지대학교1", division: "대학부", rounds: [283, 314, 307, 337], total: 1241 },
      { name: "박재형", school: "경희대학교1", division: "대학부", rounds: [281, 293, 297, 337], total: 1208 }
    ],
  },
  {
    ...
    distances: [70, 60, 50, 30],
    rows: [
      { name: "오예진", school: "광주여자대학교4", division: "대학부", rounds: [344, 343, 335, 359], total: 1381 },
      { name: "원성윤", school: "경희대학교2", division: "대학부", rounds: [326, 347, 343, 356], total: 1372 },
      { name: "염혜정", school: "경희대학교3", division: "대학부", rounds: [341, 344, 333, 354], total: 1372 },
      { name: "윤혜림", school: "창원대학교2", division: "대학부", rounds: [334, 338, 341, 355], total: 1368 },
      { name: "최혜미", school: "동서대학교2", division: "대학부", rounds: [335, 341, 334, 354], total: 1364 },
      { name: "조수혜", school: "한국체육대학교2", division: "대학부", rounds: [335, 339, 338, 351], total: 1363 },
      { name: "한주희", school: "동서대학교3", division: "대학부", rounds: [334, 338, 338, 352], total: 1362 },
      { name: "김서하", school: "순천대학교1", division: "대학부", rounds: [336, 336, 336, 354], total: 1362 },
      { name: "정다영", school: "한국체육대학교2", division: "대학부", rounds: [336, 344, 331, 350], total: 1361 },
      { name: "탁해윤", school: "순천대학교4", division: "대학부", rounds: [328, 346, 334, 350], total: 1358 },
      { name: "윤지희", school: "동서대학교2", division: "대학부", rounds: [334, 338, 336, 350], total: 1358 },
      { name: "김은지", school: "계명대학교3", division: "대학부", rounds: [337, 335, 332, 353], total: 1357 },
      { name: "나민지", school: "계명대학교4", division: "대학부", rounds: [332, 343, 334, 348], total: 1357 },
      { name: "정다예나", school: "창원대학교4", division: "대학부", rounds: [339, 335, 333, 350], total: 1357 },
      { name: "김나리", school: "한국체육대학교4", division: "대학부", rounds: [343, 337, 329, 347], total: 1356 },
      { name: "연은서", school: "계명대학교3", division: "대학부", rounds: [330, 340, 333, 352], total: 1355 },
      { name: "김세연", school: "경희대학교4", division: "대학부", rounds: [333, 344, 329, 348], total: 1354 },
      { name: "김영은", school: "원광대학교4", division: "대학부", rounds: [330, 335, 335, 352], total: 1352 },
      { name: "이수현", school: "계명대학교1", division: "대학부", rounds: [329, 340, 336, 347], total: 1352 },
      { name: "이수연", school: "광주여자대학교3", division: "대학부", rounds: [329, 335, 338, 350], total: 1352 },
      { name: "서보은", school: "순천대학교3", division: "대학부", rounds: [333, 339, 326, 353], total: 1351 },
      { name: "김수아", school: "국립경국대학교2", division: "대학부", rounds: [327, 331, 338, 351], total: 1347 },
      { name: "신고은", school: "계명대학교2", division: "대학부", rounds: [330, 340, 328, 347], total: 1345 },
      { name: "남가형", school: "광주여자대학교1", division: "대학부", rounds: [320, 337, 332, 352], total: 1341 },
      { name: "배윤진", school: "국립경국대학교1", division: "대학부", rounds: [326, 338, 327, 350], total: 1341 },
      { name: "최한별", school: "인천대학교2", division: "대학부", rounds: [333, 330, 330, 347], total: 1340 },
      { name: "최지원", school: "창원대학교4", division: "대학부", rounds: [330, 336, 323, 350], total: 1339 },
      { name: "김미강", school: "경희대학교1", division: "대학부", rounds: [327, 333, 323, 351], total: 1334 },
      { name: "오정아", school: "한국체육대학교1", division: "대학부", rounds: [320, 328, 332, 350], total: 1330 },
      { name: "김보경", school: "창원대학교2", division: "대학부", rounds: [311, 342, 330, 346], total: 1329 },
      { name: "이다영", school: "창원대학교1", division: "대학부", rounds: [318, 331, 329, 349], total: 1327 },
      { name: "박채아", school: "창원대학교1", division: "대학부", rounds: [327, 330, 329, 341], total: 1327 },
      { name: "장미", school: "경희대학교3", division: "대학부", rounds: [321, 334, 323, 347], total: 1325 },
      { name: "함지윤", school: "목원대학교2", division: "대학부", rounds: [309, 334, 333, 348], total: 1324 },
      { name: "김가은", school: "순천대학교2", division: "대학부", rounds: [324, 327, 327, 345], total: 1323 },
      { name: "이송현", school: "광주여자대학교2", division: "대학부", rounds: [313, 337, 326, 343], total: 1319 },
      { name: "박미소", school: "동서대학교1", division: "대학부", rounds: [318, 331, 320, 349], total: 1318 },
      { name: "안서윤", school: "한국체육대학교3", division: "대학부", rounds: [326, 328, 316, 347], total: 1317 },
      { name: "조아라", school: "목원대학교3", division: "대학부", rounds: [327, 325, 324, 341], total: 1317 },
      { name: "정승은", school: "한국체육대학교3", division: "대학부", rounds: [313, 329, 324, 350], total: 1316 },
      { name: "김채현", school: "목원대학교3", division: "대학부", rounds: [321, 325, 316, 352], total: 1314 },
      { name: "한유진", school: "광주여자대학교1", division: "대학부", rounds: [320, 331, 321, 335], total: 1307 },
      { name: "조민서", school: "동서대학교4", division: "대학부", rounds: [311, 330, 322, 343], total: 1306 },
      { name: "유수안", school: "상지대학교2", division: "대학부", rounds: [321, 327, 311, 343], total: 1302 },
      { name: "신효정", school: "국립경국대학교1", division: "대학부", rounds: [304, 329, 329, 338], total: 1300 },
      { name: "박재희", school: "목원대학교1", division: "대학부", rounds: [315, 331, 313, 335], total: 1294 },
      { name: "이채영", school: "인천대학교1", division: "대학부", rounds: [305, 323, 307, 348], total: 1283 },
      { name: "조명진", school: "상지대학교2", division: "대학부", rounds: [308, 322, 306, 345], total: 1281 },
      { name: "박해원", school: "울산대학교1", division: "대학부", rounds: [301, 327, 315, 336], total: 1279 },
      { name: "이예진", school: "창원대학교3", division: "대학부", rounds: [315, 320, 293, 332], total: 1260 },
      { name: "심민주", school: "인천대학교3", division: "대학부", rounds: [289, 325, 313, 330], total: 1257 },
      { name: "김하람", school: "광주여자대학교2", division: "대학부", rounds: [296, 317, 302, 333], total: 1248 }
    ],
  },
  {
  ...
  },
  {
    ...
    distances: [60, 50, 40, 30],
    rows: [
      { name: "박규필", school: "체육중", division: "중등부", rounds: [338, 335, 345, 356], total: 1374 },
      { name: "주영진", school: "이원중", division: "중등부", rounds: [334, 344, 339, 347], total: 1364 },
      { name: "김준호", school: "동진중", division: "중등부", rounds: [335, 327, 347, 350], total: 1359 },
      { name: "이상원", school: "서야중", division: "고등부", rounds: [345, 326, 350, 337], total: 1358 },
      { name: "서준용", school: "동진중", division: "중등부", rounds: [338, 326, 343, 350], total: 1357 },
      { name: "김성혁", school: "만수북중", division: "중등부", rounds: [333, 323, 342, 354], total: 1352 },
      { name: "장대한", school: "용하중", division: "고등부", rounds: [339, 331, 340, 342], total: 1352 },
      { name: "최윤찬", school: "미리벌중", division: "중등부", rounds: [338, 321, 337, 352], total: 1348 },
      { name: "오승준", school: "이원중", division: "고등부", rounds: [336, 319, 343, 347], total: 1345 },
      { name: "강민우", school: "동진중", division: "중등부", rounds: [329, 322, 344, 348], total: 1343 },
      { name: "주영빈", school: "이원중", division: "중등부", rounds: [338, 325, 331, 348], total: 1342 },
      { name: "김준서", school: "체육중", division: "중등부", rounds: [337, 331, 326, 348], total: 1342 },
      { name: "이진율", school: "불로중", division: "중등부", rounds: [339, 321, 331, 348], total: 1339 },
      { name: "박민혁", school: "모라중", division: "중등부", rounds: [335, 318, 339, 346], total: 1338 },
      { name: "안준서", school: "원천중", division: "중등부", rounds: [327, 331, 337, 341], total: 1336 },
      { name: "고현빈", school: "내동중", division: "중등부", rounds: [337, 324, 337, 338], total: 1336 },
      { name: "이재준", school: "체육중", division: "중등부", rounds: [331, 317, 332, 354], total: 1334 },
      { name: "황운재", school: "예천중", division: "고등부", rounds: [334, 316, 333, 350], total: 1333 },
      { name: "안도현", school: "미리벌중", division: "중등부", rounds: [329, 308, 341, 354], total: 1332 },
      { name: "박건우", school: "불로중", division: "고등부", rounds: [325, 325, 332, 349], total: 1331 },
      { name: "강동주", school: "무거중", division: "고등부", rounds: [321, 322, 340, 347], total: 1330 },
      { name: "안현준", school: "예천중", division: "중등부", rounds: [329, 326, 331, 344], total: 1330 },
      { name: "이재원", school: "중원중", division: "중등부", rounds: [335, 319, 331, 344], total: 1329 },
      { name: "임찬혁", school: "만수북중", division: "중등부", rounds: [324, 316, 341, 345], total: 1326 },
      { name: "서준영", school: "괴산중", division: "중등부", rounds: [328, 322, 336, 339], total: 1325 },
      { name: "이주완", school: "원천중", division: "중등부", rounds: [331, 314, 330, 348], total: 1323 },
      { name: "손우주", school: "수원시양궁협회2", division: "중등부", rounds: [323, 324, 332, 343], total: 1322 },
      { name: "김시온", school: "관악중", division: "중등부", rounds: [319, 313, 341, 348], total: 1321 },
      { name: "유지백", school: "병천중", division: "고등부", rounds: [320, 321, 337, 343], total: 1321 },
      { name: "이호진", school: "체육중", division: "중등부", rounds: [330, 310, 337, 343], total: 1320 },
      { name: "최봉석", school: "예천중", division: "고등부", rounds: [329, 308, 334, 346], total: 1317 },
      { name: "김보형", school: "수원시양궁협회2", division: "중등부", rounds: [328, 316, 333, 340], total: 1317 },
      { name: "장영한", school: "용하중", division: "중등부", rounds: [321, 321, 324, 350], total: 1316 },
      { name: "김형호", school: "무거중", division: "중등부", rounds: [332, 309, 332, 343], total: 1316 },
      { name: "우성준", school: "불로중", division: "중등부", rounds: [325, 310, 337, 343], total: 1315 },
      { name: "박지웅", school: "불로중", division: "중등부", rounds: [328, 308, 332, 346], total: 1314 },
      { name: "정현우", school: "방이중", division: "중등부", rounds: [324, 321, 325, 344], total: 1314 },
      { name: "윤성빈", school: "면목중", division: "고등부", rounds: [311, 313, 336, 352], total: 1312 },
      { name: "임지우", school: "예천중", division: "중등부", rounds: [317, 313, 333, 347], total: 1310 },
      { name: "김도겸", school: "서야중", division: "중등부", rounds: [333, 315, 316, 346], total: 1310 },
      { name: "이하늘", school: "체육중", division: "중등부", rounds: [329, 318, 321, 339], total: 1307 },
      { name: "손민서", school: "체육중", division: "중등부", rounds: [330, 329, 306, 342], total: 1307 },
      { name: "강태균", school: "예천중", division: "중등부", rounds: [319, 313, 331, 343], total: 1306 },
      { name: "김승현", school: "용성중", division: "중등부", rounds: [317, 309, 332, 348], total: 1306 },
      { name: "김태균", school: "중원중", division: "고등부", rounds: [331, 304, 330, 337], total: 1302 },
      { name: "변종율", school: "북원중", division: "중등부", rounds: [333, 304, 320, 343], total: 1300 },
      { name: "강동윤", school: "체육중", division: "고등부", rounds: [325, 317, 319, 338], total: 1299 },
      { name: "한승제", school: "체육중", division: "고등부", rounds: [318, 314, 329, 337], total: 1298 },
      { name: "이대로", school: "체육중", division: "중등부", rounds: [321, 305, 330, 341], total: 1297 },
      { name: "박주원", school: "만수북중", division: "중등부", rounds: [320, 316, 316, 344], total: 1296 },
      { name: "권태경", school: "불로중", division: "중등부", rounds: [305, 311, 336, 340], total: 1292 },
      { name: "이상윤", school: "예천중", division: "중등부", rounds: [317, 309, 327, 338], total: 1291 },
      { name: "문보량", school: "내동중", division: "중등부", rounds: [315, 308, 323, 341], total: 1287 },
      { name: "진민오", school: "원천중", division: "중등부", rounds: [302, 316, 322, 341], total: 1281 },
      { name: "홍주원", school: "방이중", division: "중등부", rounds: [319, 302, 315, 345], total: 1281 },
      { name: "유희제", school: "원천중", division: "고등부", rounds: [328, 272, 330, 344], total: 1274 },
      { name: "김태훈", school: "내동중", division: "중등부", rounds: [319, 301, 310, 343], total: 1273 },
      { name: "김강민", school: "무거중", division: "고등부", rounds: [308, 307, 323, 332], total: 1270 },
      { name: "전용현", school: "방이중", division: "고등부", rounds: [308, 293, 325, 342], total: 1268 },
      { name: "조여준", school: "체육중", division: "중등부", rounds: [310, 298, 311, 346], total: 1265 },
      { name: "김지성", school: "체육중", division: "중등부", rounds: [302, 297, 327, 338], total: 1264 },
      { name: "이시윤", school: "무거중", division: "중등부", rounds: [313, 314, 305, 325], total: 1257 },
      { name: "김용현", school: "체육중", division: "중등부", rounds: [327, 272, 324, 333], total: 1256 },
      { name: "나근도", school: "북원중", division: "고등부", rounds: [303, 300, 322, 330], total: 1255 },
      { name: "김윤조", school: "방이중", division: "중등부", rounds: [314, 288, 326, 326], total: 1254 },
      { name: "정범준", school: "무거중", division: "중등부", rounds: [299, 310, 316, 329], total: 1254 },
      { name: "양지호", school: "미리벌중", division: "고등부", rounds: [316, 288, 317, 332], total: 1253 },
      { name: "김세진", school: "원천중", division: "고등부", rounds: [295, 304, 313, 329], total: 1241 },
      { name: "정준영", school: "원천중", division: "중등부", rounds: [302, 293, 313, 332], total: 1240 },
      { name: "박예준", school: "면목중", division: "중등부", rounds: [302, 277, 324, 332], total: 1235 },
      { name: "곽우승", school: "연일중", division: "고등부", rounds: [315, 277, 313, 328], total: 1233 },
      { name: "최성민", school: "모라중", division: "고등부", rounds: [318, 267, 320, 328], total: 1233 },
      { name: "윤건우", school: "연일중", division: "중등부", rounds: [314, 301, 304, 311], total: 1230 },
      { name: "조영신", school: "중원중", division: "고등부", rounds: [291, 297, 312, 326], total: 1226 },
      { name: "심우영", school: "체육중", division: "중등부", rounds: [302, 267, 313, 340], total: 1222 },
      { name: "이건우", school: "수원시양궁협회1", division: "중등부", rounds: [314, 268, 310, 329], total: 1221 },
      { name: "김효서", school: "원봉중", division: "중등부", rounds: [305, 271, 307, 329], total: 1212 },
      { name: "김원영", school: "체육중", division: "중등부", rounds: [307, 273, 304, 321], total: 1205 },
      { name: "윤창현", school: "둔내중", division: "중등부", rounds: [305, 268, 305, 322], total: 1200 },
      { name: "이락희", school: "남천중", division: "중등부", rounds: [317, 244, 308, 325], total: 1194 },
      { name: "김수완", school: "성사중", division: "중등부", rounds: [277, 276, 315, 325], total: 1193 },
      { name: "임노건", school: "만수북중", division: "고등부", rounds: [301, 269, 287, 323], total: 1180 },
      { name: "정태준", school: "원천중", division: "중등부", rounds: [293, 257, 302, 327], total: 1179 },
      { name: "정하준", school: "체육중", division: "중등부", rounds: [301, 248, 301, 324], total: 1174 },
      { name: "김혜혁", school: "체육중", division: "중등부", rounds: [283, 279, 296, 314], total: 1172 },
      { name: "김영준", school: "만수북중", division: "중등부", rounds: [297, 279, 293, 302], total: 1171 },
      { name: "이재영", school: "병천중", division: "중등부", rounds: [294, 246, 302, 325], total: 1167 },
      { name: "서원빈", school: "내동중", division: "중등부", rounds: [306, 237, 293, 329], total: 1165 },
      { name: "전성은", school: "병천중", division: "중등부", rounds: [304, 261, 291, 307], total: 1163 },
      { name: "김지후", school: "원봉중", division: "중등부", rounds: [304, 239, 296, 323], total: 1162 },
      { name: "방채영", school: "연일중", division: "중등부", rounds: [262, 261, 302, 324], total: 1149 },
      { name: "김규선", school: "방이중", division: "중등부", rounds: [289, 260, 275, 317], total: 1141 },
      { name: "김규성", school: "면목중", division: "중등부", rounds: [265, 226, 290, 312], total: 1093 },
      { name: "정우진", school: "면목중", division: "고등부", rounds: [257, 251, 258, 315], total: 1081 },
  ...
  },
  {
    ...
    distances: [35, 30, 25, 20],
    rows: [
      { name: "신동주", school: "이원초", division: "중등부", rounds: [345, 350, 356, 360], total: 1411 },
      { name: "양가온", school: "송현초", division: "중등부", rounds: [348, 345, 355, 358], total: 1406 },
      { name: "박서준", school: "덕인초", division: "중등부", rounds: [336, 350, 355, 358], total: 1399 },
      { name: "김주완", school: "명덕초", division: "중등부", rounds: [335, 349, 350, 353], total: 1387 },
      { name: "정재윤", school: "부평서초", division: "중등부", rounds: [334, 347, 350, 354], total: 1385 },
      { name: "조재혁", school: "모덕초", division: "중등부", rounds: [342, 343, 345, 355], total: 1385 },
      { name: "이도현", school: "동부초", division: "중등부", rounds: [341, 342, 343, 355], total: 1381 },
      { name: "이환지", school: "천현초", division: "중등부", rounds: [325, 347, 352, 355], total: 1379 },
      { name: "강민국", school: "천현초", division: "중등부", rounds: [336, 341, 345, 355], total: 1377 },
      { name: "박수한", school: "좌수영초", division: "초등부(고학년)", rounds: [336, 339, 349, 353], total: 1377 },
      { name: "안태빈", school: "병천초", division: "중등부", rounds: [328, 341, 353, 354], total: 1376 },
      { name: "김도율", school: "석암초", division: "중등부", rounds: [334, 337, 347, 357], total: 1375 },
      { name: "송민준", school: "창녕초", division: "중등부", rounds: [340, 337, 345, 350], total: 1372 },
      { name: "최여준", school: "금릉초", division: "중등부", rounds: [335, 339, 344, 352], total: 1370 },
      { name: "한지환", school: "병천초", division: "중등부", rounds: [336, 342, 344, 348], total: 1370 },
      { name: "반승우", school: "경화초", division: "중등부", rounds: [328, 339, 349, 351], total: 1367 },
      { name: "유찬", school: "서부초", division: "중등부", rounds: [327, 332, 352, 353], total: 1364 },
      { name: "이찬희", school: "동부초", division: "중등부", rounds: [328, 335, 341, 358], total: 1362 },
      { name: "권도훈", school: "남천초", division: "중등부", rounds: [338, 338, 336, 350], total: 1362 },
      { name: "김민수", school: "신계초", division: "중등부", rounds: [330, 338, 341, 353], total: 1362 },
      { name: "김수현", school: "경화초", division: "중등부", rounds: [317, 346, 344, 353], total: 1360 },
      { name: "우치수", school: "기린초", division: "초등부(고학년)", rounds: [325, 338, 346, 348], total: 1357 },
      { name: "권동하", school: "서부초", division: "중등부", rounds: [315, 342, 344, 355], total: 1356 },
      { name: "서은민", school: "성포초", division: "중등부", rounds: [331, 336, 337, 350], total: 1354 },
      { name: "김종민", school: "방이초", division: "중등부", rounds: [327, 333, 338, 354], total: 1352 },
      { name: "황정민", school: "옥서초", division: "초등부(고학년)", rounds: [338, 335, 337, 341], total: 1351 },
      { name: "정은균", school: "예천초", division: "중등부", rounds: [329, 332, 339, 349], total: 1349 },
      { name: "이정우", school: "명륜초", division: "중등부", rounds: [329, 328, 345, 346], total: 1348 },
      { name: "이승훈", school: "설악초", division: "중등부", rounds: [326, 339, 340, 343], total: 1348 },
      { name: "송현빈", school: "대평초", division: "중등부", rounds: [324, 339, 334, 349], total: 1346 },
      { name: "김성훈", school: "서면초", division: "초등부(고학년)", rounds: [325, 333, 342, 344], total: 1344 },
      { name: "조담준", school: "삼정초", division: "중등부", rounds: [325, 324, 345, 349], total: 1343 },
      { name: "이은호", school: "오창초", division: "중등부", rounds: [329, 332, 330, 349], total: 1340 },
      { name: "양지율", school: "북가좌초", division: "초등부(고학년)", rounds: [317, 339, 341, 342], total: 1339 },
      { name: "이호태", school: "석암초", division: "초등부(고학년)", rounds: [309, 335, 345, 346], total: 1335 },
      { name: "곽래우", school: "삼정초", division: "초등부(고학년)", rounds: [324, 317, 337, 352], total: 1330 },
      { name: "임채민", school: "개봉초", division: "초등부(고학년)", rounds: [327, 319, 339, 344], total: 1329 },
      { name: "김진원", school: "기린초", division: "초등부(고학년)", rounds: [312, 335, 335, 343], total: 1325 },
      { name: "강윤우", school: "창녕초", division: "중등부", rounds: [310, 334, 340, 340], total: 1324 },
      { name: "이도윤", school: "서부초", division: "중등부", rounds: [317, 321, 339, 346], total: 1323 },
      { name: "김도진", school: "설악초", division: "중등부", rounds: [319, 326, 331, 346], total: 1322 },
      { name: "손승우", school: "가장초", division: "중등부", rounds: [317, 326, 332, 347], total: 1322 },
      { name: "박태환", school: "가장초", division: "중등부", rounds: [318, 325, 334, 342], total: 1319 },
      { name: "김세현", school: "옥서초", division: "중등부", rounds: [315, 325, 328, 350], total: 1318 },
      { name: "김도현", school: "서부초", division: "초등부(고학년)", rounds: [308, 329, 327, 341], total: 1305 },
      { name: "박민수", school: "개봉초", division: "중등부", rounds: [311, 310, 340, 342], total: 1303 },
      { name: "이준혁", school: "복산초", division: "초등부(고학년)", rounds: [308, 327, 330, 337], total: 1302 },
      { name: "장은혁", school: "연무초", division: "초등부(고학년)", rounds: [307, 318, 334, 340], total: 1299 },
      { name: "정진원", school: "성진초", division: "중등부", rounds: [308, 318, 329, 336], total: 1291 },
      { name: "백준", school: "가장초", division: "초등부(고학년)", rounds: [298, 323, 329, 340], total: 1290 },
      { name: "이주원", school: "대평초", division: "초등부(고학년)", rounds: [309, 317, 321, 340], total: 1287 },
      { name: "임형규", school: "오수초", division: "중등부", rounds: [298, 323, 326, 337], total: 1284 },
      { name: "김태하", school: "좌수영초", division: "중등부", rounds: [317, 304, 316, 339], total: 1276 },
      { name: "김소율", school: "성남초", division: "중등부", rounds: [299, 304, 327, 340], total: 1270 },
      { name: "이주원", school: "일로초", division: "중등부", rounds: [274, 315, 327, 344], total: 1260 },
      { name: "천미르", school: "기린초", division: "초등부(고학년)", rounds: [290, 308, 332, 330], total: 1260 },
      { name: "박진서", school: "병천초", division: "중등부", rounds: [291, 296, 328, 335], total: 1250 },
      { name: "이지한", school: "복산초", division: "초등부(고학년)", rounds: [279, 311, 318, 337], total: 1245 },
      { name: "정민규", school: "명륜초", division: "중등부", rounds: [283, 292, 315, 349], total: 1239 },
      { name: "조유준", school: "삼정초", division: "중등부", rounds: [269, 300, 315, 347], total: 1231 },
  ...
  },
  {
    ...
    distances: [35, 30, 25, 20],
    rows: [
      { name: "김다을", school: "용성초", division: "중등부", rounds: [346, 349, 355, 355], total: 1405 },
      { name: "고다현", school: "방이초", division: "중등부", rounds: [333, 350, 356, 356], total: 1395 },
      { name: "장채윤", school: "정평초", division: "중등부", rounds: [336, 342, 350, 359], total: 1387 },
      { name: "임예은", school: "신동초", division: "중등부", rounds: [338, 348, 343, 356], total: 1385 },
      { name: "이수빈", school: "촉석초", division: "중등부", rounds: [329, 346, 345, 355], total: 1375 },
      { name: "한세빈", school: "송정초", division: "중등부", rounds: [337, 342, 343, 352], total: 1374 },
      { name: "조유나", school: "하성초", division: "초등부(고학년)", rounds: [330, 342, 347, 355], total: 1374 },
      { name: "윤이서", school: "홍남초", division: "중등부", rounds: [331, 337, 346, 358], total: 1372 },
      { name: "고윤우", school: "유촌초", division: "중등부", rounds: [328, 344, 342, 349], total: 1363 },
      { name: "이승혜", school: "진해중앙초", division: "중등부", rounds: [325, 335, 346, 355], total: 1361 },
      { name: "김예빈", school: "중앙초", division: "중등부", rounds: [326, 334, 347, 353], total: 1360 },
      { name: "박예나", school: "반곡초", division: "중등부", rounds: [333, 335, 341, 351], total: 1360 },
      { name: "석지우", school: "하성초", division: "중등부", rounds: [319, 331, 351, 357], total: 1358 },
      { name: "이은정", school: "대미초", division: "중등부", rounds: [328, 332, 348, 350], total: 1358 },
      { name: "허정아", school: "하성초", division: "중등부", rounds: [324, 335, 344, 355], total: 1358 },
      { name: "함주하", school: "용성초", division: "초등부(고학년)", rounds: [327, 330, 352, 349], total: 1358 },
      { name: "이서윤", school: "신동초", division: "중등부", rounds: [325, 337, 341, 354], total: 1357 },
      { name: "문현정", school: "밀주초", division: "중등부", rounds: [317, 334, 349, 356], total: 1356 },
      { name: "이지나", school: "갈월초", division: "초등부(고학년)", rounds: [321, 335, 343, 357], total: 1356 },
      { name: "류가예", school: "송현초", division: "중등부", rounds: [328, 329, 348, 350], total: 1355 },
      { name: "이선민", school: "홍남초", division: "중등부", rounds: [332, 331, 340, 349], total: 1352 },
      { name: "임현서", school: "서부초", division: "중등부", rounds: [325, 331, 342, 354], total: 1352 },
      { name: "염정민", school: "계림초", division: "중등부", rounds: [313, 337, 345, 356], total: 1351 },
      { name: "김지수", school: "중앙초", division: "중등부", rounds: [321, 332, 345, 353], total: 1351 },
      { name: "김소율", school: "동부초", division: "중등부", rounds: [324, 333, 340, 353], total: 1350 },
      { name: "이가은", school: "갈월초", division: "중등부", rounds: [317, 337, 345, 349], total: 1348 },
      { name: "양서정", school: "반곡초", division: "중등부", rounds: [332, 324, 337, 353], total: 1346 },
      { name: "허윤", school: "중앙초", division: "중등부", rounds: [312, 339, 345, 349], total: 1345 },
      { name: "남예온", school: "신계초", division: "초등부(고학년)", rounds: [320, 330, 339, 355], total: 1344 },
      { name: "최서현", school: "반곡초", division: "중등부", rounds: [326, 329, 342, 347], total: 1344 },
      { name: "이아영", school: "태평초", division: "중등부", rounds: [309, 333, 347, 354], total: 1343 },
      { name: "진연아", school: "문산초", division: "중등부", rounds: [315, 330, 346, 352], total: 1343 },
      { name: "윤세아", school: "갈월초", division: "중등부", rounds: [315, 335, 342, 351], total: 1343 },
      { name: "이주은", school: "대미초", division: "중등부", rounds: [325, 330, 343, 340], total: 1338 },
      { name: "최지아", school: "임실군양궁스포츠클럽6", division: "초등부(통합)", rounds: [311, 332, 345, 349], total: 1337 },
      { name: "서인교", school: "중앙초", division: "중등부", rounds: [315, 329, 339, 353], total: 1336 },
      { name: "나연우", school: "인헌초", division: "중등부", rounds: [318, 337, 333, 347], total: 1335 },
      { name: "정예서", school: "인헌초", division: "중등부", rounds: [311, 328, 345, 349], total: 1333 },
      { name: "전세희", school: "갈월초", division: "중등부", rounds: [317, 319, 340, 355], total: 1331 },
      { name: "김도연", school: "반곡초", division: "중등부", rounds: [317, 326, 336, 348], total: 1327 },
      { name: "노유림", school: "황금초", division: "초등부(고학년)", rounds: [322, 326, 330, 349], total: 1327 },
      { name: "신서연", school: "태평초", division: "초등부(고학년)", rounds: [310, 324, 336, 353], total: 1323 },
      { name: "임유빈", school: "대평초", division: "중등부", rounds: [309, 321, 339, 351], total: 1320 },
      { name: "성예나", school: "정평초", division: "중등부", rounds: [312, 330, 336, 339], total: 1317 },
      { name: "김소원", school: "밀주초", division: "중등부", rounds: [300, 330, 341, 340], total: 1311 },
      { name: "임예은", school: "남천초", division: "중등부", rounds: [311, 327, 327, 339], total: 1304 },
      { name: "오윤아", school: "강남초", division: "중등부", rounds: [312, 314, 334, 342], total: 1302 },
      { name: "전서아", school: "중앙초", division: "중등부", rounds: [307, 315, 335, 343], total: 1300 },
      { name: "김하늘", school: "대덕초", division: "중등부", rounds: [312, 310, 340, 337], total: 1299 },
      { name: "김선율", school: "홍남초", division: "초등부(고학년)", rounds: [294, 314, 342, 343], total: 1293 },
      { name: "배재이", school: "대평초", division: "초등부(고학년)", rounds: [318, 307, 322, 340], total: 1287 },
      { name: "송해인", school: "신동초", division: "초등부(고학년)", rounds: [289, 307, 334, 337], total: 1267 },
      { name: "김하온", school: "두암초", division: "중등부", rounds: [291, 309, 315, 341], total: 1256 },
      { name: "황국영", school: "문산초", division: "초등부(고학년)", rounds: [272, 306, 326, 333], total: 1237 },
      { name: "임소연", school: "송촌초", division: "중등부", rounds: [310, 318, 273, 336], total: 1237 },
      { name: "최지은", school: "청량초", division: "중등부", rounds: [292, 288, 317, 331], total: 1228 },
      { name: "최진솔", school: "덕인초", division: "초등부(고학년)", rounds: [269, 303, 320, 333], total: 1225 },
      { name: "안리안", school: "일로초", division: "중등부", rounds: [277, 294, 317, 333], total: 1221 },
      { name: "이혜진", school: "성남초", division: "중등부", rounds: [268, 280, 323, 327], total: 1198 },
      { name: "용지혜", school: "모덕초", division: "초등부(고학년)", rounds: [253, 261, 296, 293], total: 1103 }
    ],
  }
];
...
function RankingBoard({ users, sessions, currentUser, currentUserId, officialClaims = [], onRequestOfficialClaim }) {
  ...
  const rankingGroupOptions = useMemo(() => sortKoreanOptions(RANKING_GROUP_OPTIONS), [sortKoreanOptions]);
          ...
          <div className="grid gap-2">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <div className="min-w-0 flex-1 space-y-2">
                ...
                >
                  {[...DATE_FILTER_OPTIONS].sort((a, b) => a.label.localeCompare(b.label, "ko-KR")).map((item) => (
