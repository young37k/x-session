...
const SAMPLE_SHEETS = [
  {
    id: "dev_sample_elem_lower_boys_2026_jongbyeol",
    sheetLabel: "개발용 샘플 · 종별대회 남자 초등 U-10",
    ...
    rows: [
      { rank: 1, name: "김영재", school: "연무초등학교", rounds: [310, 339, 338, 350], total: 1337, sourceRank: 1 },
      { rank: 2, name: "변지성", school: "인천부평서초등학교", rounds: [317, 321, 344, 354], total: 1336, sourceRank: 2 },
      { rank: 3, name: "김여울", school: "용성초등학교", rounds: [326, 327, 335, 347], total: 1335, sourceRank: 3 },
    ],
  },
  {
    id: "dev_sample_elem_lower_girls_2026_jongbyeol",
    sheetLabel: "개발용 샘플 · 종별대회 여자 초등 U-10",
    competitionId: "2026_jongbyeol_60",
    competitionName: "제60회 전국 남여 양궁 종별선수권 대회",
    date: "2026-05-02",
    regionCity: "전국",
    ...
    distances: [35, 30, 25, 20],
    rows: [
      { rank: 1, name: "김태리", school: "김포하성초등학교", rounds: [310, 332, 329, 349], total: 1320, sourceRank: 1 },
      { rank: 2, name: "이슬기", school: "홍남초등학교", rounds: [314, 324, 331, 349], total: 1318, sourceRank: 2 },
      { rank: 3, name: "정별하", school: "용암초등학교", rounds: [300, 319, 335, 344], total: 1298, sourceRank: 3 },
    ],
  },
  {
    id: "dev_sample_middle_boys_2026_jongbyeol",
    sheetLabel: "개발용 샘플 · 종별대회 남자 중학부",
    competitionId: "2026_jongbyeol_60",
    competitionName: "제60회 전국 남여 양궁 종별선수권 대회",
    date: "2026-05-02",
    regionCity: "전국",
    ...
    rows: [
      { rank: 1, name: "조강민", school: "순천풍덕중학교", rounds: [337, 335, 348, 357], total: 1377, sourceRank: 1 },
      { rank: 2, name: "안은찬", school: "성포중학교", rounds: [348, 331, 340, 354], total: 1373, sourceRank: 2 },
      { rank: 3, name: "손민서", school: "경북체육중학교", rounds: [333, 337, 342, 360], total: 1372, sourceRank: 3 },
    ],
  },
  {
    id: "dev_sample_middle_girls_2026_jongbyeol",
    sheetLabel: "개발용 샘플 · 종별대회 여자 중학부",
    competitionId: "2026_jongbyeol_60",
    competitionName: "제60회 전국 남여 양궁 종별선수권 대회",
    date: "2026-05-02",
    regionCity: "전국",
    ...
    distances: [60, 50, 40, 30],
    rows: [
      { rank: 1, name: "윤노을", school: "대전대청중학교", rounds: [344, 334, 348, 357], total: 1383, sourceRank: 1 },
      { rank: 2, name: "류수민", school: "부일중학교", rounds: [336, 327, 347, 349], total: 1359, sourceRank: 2 },
      { rank: 3, name: "박수연", school: "경북체육중학교", rounds: [342, 317, 344, 352], total: 1355, sourceRank: 3 },
    ],
  },
  {
    id: "dev_sample_high_boys_2026_jongbyeol",
    sheetLabel: "개발용 샘플 · 종별대회 남자 고등부",
    competitionId: "2026_jongbyeol_60",
    competitionName: "제60회 전국 남여 양궁 종별선수권 대회",
    date: "2026-05-02",
    regionCity: "전국",
    ...
    rows: [
      { rank: 1, name: "김태서", school: "충북체육고등학교", rounds: [312, 337, 328, 353], total: 1330, sourceRank: 1 },
      { rank: 2, name: "김성용", school: "광주체육고등학교", rounds: [315, 331, 334, 339], total: 1319, sourceRank: 2 },
      { rank: 3, name: "임은재", school: "인천영선고등학교", rounds: [310, 326, 331, 351], total: 1318, sourceRank: 3 },
    ],
  },
  {
    id: "dev_sample_high_girls_2026_jongbyeol",
    sheetLabel: "개발용 샘플 · 종별대회 여자 고등부",
    competitionId: "2026_jongbyeol_60",
    competitionName: "제60회 전국 남여 양궁 종별선수권 대회",
    date: "2026-05-02",
    regionCity: "전국",
    ...
    rows: [
      { rank: 1, name: "윤가영", school: "홍성여자고등학교", rounds: [331, 343, 334, 354], total: 1362, sourceRank: 1 },
      { rank: 2, name: "고하린", school: "대전체육고등학교", rounds: [326, 341, 331, 350], total: 1348, sourceRank: 2 },
      { rank: 3, name: "김수민", school: "부산체육고등학교", rounds: [328, 338, 327, 353], total: 1346, sourceRank: 3 },
    ],
  },
];
...
function getRankingQueryTarget(rankingFilters = {}, currentUser = null) {
  const profileGroup = getRankingGroup(currentUser?.division, currentUser?.gender);
  const rankingGroup = rankingFilters.rankingGroup && rankingFilters.rankingGroup !== "all"
    ? rankingFilters.rankingGroup
    : profileGroup || "all";
  const gender = rankingFilters.gender && rankingFilters.gender !== "all"
